    ...
    <div class="wp-chatbot-container">
        ...
        <div id="wp-chatbot-board-container" class="wp-chatbot-board-container">
			<div class="wp-chatbot-header">
                ...
                <!-- wp-chatbot-desktop-close1 this added by trupti -->
                <div id="wp-chatbot-desktop-close1" title="<?php echo(get_option('qlcd_wp_chatbot_close_lan') != '' ? get_option('qlcd_wp_chatbot_close_lan') : 'Close'); ?>"><i class="fa fa-times" aria-hidden="true"></i></div>
