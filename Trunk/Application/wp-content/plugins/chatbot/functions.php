...
function wp_chatbot_load_footer_html(){
    ...
    if (get_option('disable_wp_chatbot') != 1 && wp_chatbot_load_controlling() === true) {
        ...
        ?>
         <!-- Thsi code commented by trupti for mark up error -->
        <!-- <style>
      ...
      <?php esc_html_e('X', 'wpchatbot'); ?>
            ...
            <div id="wp-chatbot-ball" class="">
                <div class="wp-chatbot-ball">
                    ...
                    ?>
                    <!-- Here the code data-qcld-agent added by trupti after removed qcld_agent -->
                    <img src="<?php echo $wp_chatbot_custom_icon_path; ?>"
                         alt="wpChatIcon" data-qcld-agent="<?php echo esc_url($wp_chatbot_custom_icon_path); ?>" >
...
function wp_chatbot_shortcode_dom($atts){
    ...
    <!-- This code commented by trupti for removing markup error -->
    <!-- <style>
        .wp-chatbot-container {
...
function wp_chatbot_mobile_app_short_code(){ ?>
    ...
    ?>
    <!-- Commented By trupti for resolving mark up error -->
    <!-- <style>
        .wp-chatbot-container {
            background: url(<?php echo $qcld_wb_chatbot_board_bg_path ;?>) no-repeat top right !important;
        }
