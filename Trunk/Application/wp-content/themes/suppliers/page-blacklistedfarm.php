<?php
/**
 * Template Name: Blacklisted Firms Template
			...
			<div class="row justify-content-between ">
				...
				<div class="col-md-6">
					<div class="tenderheading">
						<a class="linkBtn" href="archived-blacklisted-firms">Archive<span></span></a>
					</div>
				</div>
			</div>
									...
									<tr>
										...
										<td>
											...
											<div class="modal fade" id="modal-<?php echo $post_id; ?>" tabindex="-1"
												role="dialog" aria-labelledby="modalLabel-<?php echo $post_id; ?>" aria-hidden="true">
