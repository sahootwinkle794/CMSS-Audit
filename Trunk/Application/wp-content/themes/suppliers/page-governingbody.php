<?php
/**
 * Template Name: Governing Body Template
...
<div class="container">
	<!-- moved the main tag to remove the mark up error bty trupti -->
		...
		?>         
			...
			?>				
				<div class="col-md-3 col-sm-3 col-xs-12 member-item text-center">
					...
					<?php if($member_image){ ?>
						<img alt="" src="<?php echo $member_image;?>">
					<?php }else { ?>
						<img alt="" src="<?php echo get_template_directory_uri();?>/assets/img/no-image.jpg">
					<?php } ?>
					</figure></div>
