...
$(document).ready(function(){
	...
	var urls =base_url+"/ajax_controller/get_datatable_data/get_groupdata";
	...
	$('#cmbtable').change(function(){
		...
		$.ajax({
			url:base_url+"/ajax_controller/get_tablevalue",
			type:"POST",
			data:{
				table_name:cmbtable,
	...
	$('#frm_group').bootstrapValidator({
		...
		submitHandler: function(validator, form, submitButton) 
		{
			...
			urls =base_url+"/ajax_controller/operation_groupdata";
			$.ajax({
				url : urls,
				method : 'POST',
				data:formData,
	...
	* 
	...
	var url =base_url+"ajax_controller/get_datatable_data/get_role_group_data";
	var dtblrolegroupmapping = $('#dtblrolegroupmapping').dataTable({
        ...
        "columns": [
           ...
           { "sName": "button","sClass":"alignCenter","sDefaultContent":"<button type='button' class='btn btn-info btn-circle'  onclick='updateRoleGroup(event);' id='edit' ><i class='fa fa-pencil-square-o'></i></button>&nbsp;\
           				<button type='button' class='btn btn-danger btn-circle' onclick='deleteRoleGroup(event);'  id='delete'><i class='fa fa-trash'></i></button>"
	       },
        ],
	...
	*/	
	...
	$('#frm_role_group').bootstrapValidator({
		...
		submitHandler: function(validator, form, submitButton){
			...
			$.ajax({
		        type: "POST",
		        url: base_url + "ajax_controller/operation_role_group_data",
				data:formData,
				cache: false,
		        contentType: false,
		        processData: false,
	...
	*/ 
	...
	var url =base_url+"ajax_controller/get_datatable_data/get_user_role_group_data";
	var dtblUser_Role_group_mapping = $('#dtblUser_Role_group_mapping').dataTable({
        ...
        "columns": [
           ...
           { "sName": "button","sClass":"alignCenter","sDefaultContent":"<button type='button' class='btn btn-danger btn-circle' onclick='deleteUserRoleGroup(event);'  id='delete'><i class='fa fa-trash'></i></button>"
	       },
        ],
	...
	//on change of rolegroup dropdown it will assign the value and reloading the datatable
	...
	*/	
	...
	$('#frm_userrolegroup').bootstrapValidator({
		...
		submitHandler: function(validator, form, submitButton){
			...
			$.ajax({
		        type: "POST",
		        url: base_url + "ajax_controller/operation_user_rolegroup_data",
				data:formData,
				cache: false,
		        contentType: false,
		        processData: false,
...
function editGroupData(event){
    ...
    var urls =base_url+"/ajax_controller/get_datatable_data/get_tablemapvalue";
