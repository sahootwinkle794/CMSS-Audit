$(document).ready(function(){
	...
	$("#btnShow").click(function(){
		...
		else
		{
			...
			window.open("admitcard_published_applicants/"+program_code_new+"/"+exam_center_code+"/"+exam_vanue_new+"/"+cmbRound,"winadmicardapplicant","left=0,top=0,width=1024,height=700,scrollbars=1,menubar=0,status=0,toolbar=0").focus();	
		}
	});
		...
		if(program_code !='')
		{
			...
			var institutedata = {
				...
				success:function(response){ 
					...
					var options = "<option value =''>Assigned Exam Center</option>";
					var res1 = JSON.parse(response);
					$.each(res1.aaData,function(i,data){
