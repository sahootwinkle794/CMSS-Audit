...
foreach($application_data as $row)
{
	...
	if($application_no != '')
		$edit = "true";
	if($appl_status == 'Verified' || $appl_status == 'Fee Paid' || $appl_status == 'Student Details Submitted' || $appl_status == 'Document Uploaded' )
		$show = 1;
}
//********************************************* Details in template *******************************//
						...
						<div class="col-lg-12" style="box-shadow: 0px 7px 20px -6px #090909; background-color: #F1F1F1;border: 1px solid rgb(255, 255, 255); border-radius: 5px; width: 100%;height: auto;padding: 21px;margin-top: 5px;">
							...
							<!--************START OF NAME ROW**********--> 
							             ...
							             <div class="row">
								               <div class="col-lg-12">
													<div class="form-group">
														<label for="" class="col-lg-5" ><i style="color:red;font-size:18px;">*</i> APPLICATION FOR MPT / MOT / MPO:</label>
														<div class="col-lg-7">
...
<!--**************START OF EMAIL ID AND Aadhaar NUMBER*********-->
											<div  class="row"  style="margin-top: 20px;">
													...
													<div class="form-group">
														...
														<div class="col-lg-7">
															<input type="text" class="form-control" id="txtFatherName" name="txtFatherName" placeholder="Enter Father Name" maxlength="80"  onkeyup="changeCase(this)"  value="<?=strtoupper($txtFatherName)?>" <?php echo $show==1?'disabled':''; ?>>
														</div>
													</div>
												</div> -->
                             ...
                             <!--  <div  class="row"  style="margin-top: 20px;">
												...
												<div class="col-lg-6">
													<div class="form-group">
														<label for="" class="col-lg-5" style="m"><i style="color:red;font-size:18px;">*</i> <i class="fa fa-credit-card" aria-hidden="true" style="color:#E4791A"></i> Father's Profession</label>
														<div class="col-lg-7">
							...
							<div class="col-lg-6">
								<div class="form-group">
									...
									<div class="col-lg-7">
										<input type="email" class="form-control" id="txtemailid" name="txtemailid"  value="<?=$txtEmailId?>" data-placement="top" data-toggle="tooltip" title="Your Email-id. Ex: xyz@gmail.com" disabled>
									</div>
								</div>
							</div>
						</div>
							...
							<div  class="row" style="margin-top: 20px;">
								...
								<div class="col-lg-8">
									<div class="form-group" >
										<label for="" class="col-lg-7 " ><i style="color:red;font-size:18px;">*</i> <i class="fa fa-wheelchair" aria-hidden="true" style="color:#E4791A";></i> Belongs to PH</label>
							...
							<!--**************END OF GENDER AND PHYSICAL FITNESS*********-->
											...
											<div  class="row" style="margin-top: 20px;">
												<div class="col-sm-6">
													<div class="form-group">
														<label for="" class="col-lg-5" style=""><i style="color:red;font-size:18px;">*</i> <i class="fa fa-map-marker" aria-hidden="true" style="color:#E4791A"></i> Candidate Belongs to North East Region?</label>
														<div class="col-lg-7">
															<label class="radio-inline">
						...
						<div class="col-lg-12" style="box-shadow: 0px 7px 20px -6px #090909; background-color: #F1F1F1;border: 1px solid rgb(255, 255, 255); border-radius: 5px; width: 100%;height: auto;padding: 21px;margin-top: 20px;">
							<h3 style="text-align: center;margin-top: -6px;color: #666;"> FATHER'S DETAILS</h3>
											<div  class="row"  style="margin-top: 20px;">
												<div class="col-lg-6">
													<div class="form-group">
												...
												<div class="col-lg-6">
													<div class="form-group">
														<label for="" class="col-lg-5" style=""><i style="color:red;font-size:18px;">*</i> <i class="fa fa-credit-card" aria-hidden="true" style="color:#E4791A"></i> Father's Profession</label>
														<div class="col-lg-7">
										    ...
										    <div  class="row"  style="margin-top: 20px;">
											   <div class="col-lg-6">
													<div class="form-group">
														<label for="" class="col-lg-5" style=""><i style="color:red;font-size:18px;">*</i> <i class="fa fa-male" aria-hidden="true" style="color:#E4791A"></i> Father's Annual Income</label>
														<div class="col-lg-7">
															<input type="text" class="form-control" id="FathersIncome" name="FathersIncome" onkeypress="return isNumberKey(event)" placeholder="Enter Fathers Income"   value="<?=$FathersIncome;?>" maxlength="8" data-placement="top" data-toggle="tooltip" title="Your Father's Annual Income. Put 0(zero) if no Income. Ex:20000000 or 0" >
														</div>
													</div>
												</div>
												...
												<!--<div class="col-lg-6">
													<div class="form-group">
														<label for="" class="col-lg-5" style="m">&nbsp;&nbsp;<i class="fa fa-credit-card" aria-hidden="true" style="color:#E4791A"></i> Father's Aadhaar No</label>
														<div class="col-lg-7">
															<input type="text" class="form-control test" id="txtUid" name="txtUidF" placeholder="Enter Aadhaar No" maxlength="12" onkeypress="return isNumberKey(event)"   value="<?=$FathersAdhar?>" data-placement="top" data-toggle="tooltip" title="Aadhaar No must be a digit. Ex:123456789012" >
														</div>
													</div>
												</div>-->
										...
										<div class="col-lg-12" style="box-shadow: 0px 7px 20px -6px #090909; background-color: #F1F1F1;border: 1px solid rgb(255, 255, 255); border-radius: 5px; width: 100%;height: auto;padding: 21px;margin-top: 20px;">
											<h3 style="text-align: center;margin-top: -6px;color: #666;"> MOTHER'S DETAILS</h3>
											<div  class="row"  style="margin-top: 20px;">
												<div class="col-lg-6">
													<div class="form-group">
														...
														<div class="col-lg-7">
															<input type="text" class="form-control" id="txtMotherName" name="txtMotherName" placeholder="Enter Mother Name" maxlength="80"  onkeyup="changeCase(this)"  value="<?=strtoupper($MothersName)?>" >
														</div>
													</div>
												</div>
												...
												<div class="col-lg-6">
													<div class="form-group">
														<label for="" class="col-lg-5" style="">&nbsp;&nbsp;<i class="fa fa-credit-card" aria-hidden="true" style="color:#E4791A"></i> Mother's Profession</label>
														<div class="col-lg-7">
															<input type="text" class="form-control test" id="MothersProfession" name="MothersProfession" placeholder="Enter Mothers Profession" maxlength="80"  onkeyup="changeCase(this)" data-placement="top" data-toggle="tooltip" value="<?=$MothersProfession?>" title="" >
														</div>
													</div>
											...
											<div  class="row"  style="margin-top: 20px;">												
														...
														<div class="col-lg-6">
													<div class="form-group">
														<label for="" class="col-lg-5" style=""><i style="color:red;font-size:18px;">*</i> <i class="fa fa-male" aria-hidden="true" style="color:#E4791A"></i> Mother's Annual Income</label>
														<div class="col-lg-7">
															<input type="text" class="form-control" id="MothersIncome" name="MothersIncome" onkeypress="return isNumberKey(event)" placeholder="Enter Mothers Income"   value="<?=$MothersIncome?>" maxlength="8" data-placement="top" data-toggle="tooltip" title="Your Mother's Annual Income. Put 0(zero) if no Income. Ex:20000000 or 0" >
														</div>
													</div>
												</div>
										...
										<div class="col-lg-12" style="box-shadow: 0px 7px 20px -6px #090909; background-color: #F1F1F1;border: 1px solid rgb(255, 255, 255); border-radius: 5px; width: 100%;height: auto;padding: 21px;    margin-top: 35px;">
											...
											<div class="row">
												<!-- <div class="col-lg-6">
													<div class="form-group">
														<label for="" class="col-lg-5" style="    padding-right: 35px;"><i style="color:red;font-size:18px;">*</i> <i class="fa fa-home" aria-hidden="true" style="color:#E4791A;"></i> Name</label>
														<div class="col-lg-7">
															<input type="text" class="form-control" name="cand_name" id="cand_name"  onkeyup="changeCase(this)" maxlength="80" value="<?=$cand_name?>" >
														</div>
													</div>
												</div> -->
												<div class="col-lg-6">
											...
											<div class="row">
												 <!-- <div class="col-lg-6">
													<div class="form-group">
														<label for="" class="col-lg-5" style="    padding-right: 35px;"><i style="color:red;font-size:18px;">*</i> <i class="fa fa-home" aria-hidden="true" style="color:#E4791A;"></i> Name</label>
														<div class="col-lg-7">
															<input type="text" class="form-control" name="cand_name1" id="cand_name1" onkeyup="changeCase(this)" maxlength="80" value="<?=$cand_name1?>"  >
														</div>
													</div>
												</div>  -->
												<div class="col-lg-6">
										...
										<div class="col-sm-12" id="employer_id" style="background: #fff; padding-top: 10px;" <?php if($is_employed=="YES") { echo ""; } else { echo 'hidden'; }?> >
												...
												<table class=" col-sm-12 table">
													...
													<tbody>
														...
														<!--
														<tr>
															<td><input type="text" class="form-control" name="Employer_address1" value="<?=$employer_add1?>" <?php echo $show==1?'disabled':''; ?>></td>
															<td><input type="text" class="form-control" name="Employer_from1" value="<?=$employer_from1?>" <?php echo $show==1?'disabled':''; ?>></td>
															<td><input type="text" class="form-control" name="Employer_to1" value="<?=$employer_to1?>" <?php echo $show==1?'disabled':''; ?>></td>
														</tr>-->
													</tbody>
												</table>
											</div>
										...
										<div class="row" >
											...
											<div class="col-md-12">
												<div class="form-group col-md-9 ">
													...
													<div class="col-lg-7">
														<input type="text" class="form-control " name="txtfinalpercentage" maxlength="5" max="101" value="<?=$txtfinalpercentage?>" id="txtfinalpercentage" onchange="change_per()"   >
													</div>
												</div>
											</div>
										</div>
									...
									<div class="row">
										<div class="form-group">
											<div class="col-sm-12" align="justify">
												...
												be denied the opportunity to appear the ENTRANCE TEST/ADMISSION. If already admitted, my admission
												will be cancelled. I also understand that the decision of the authorities regarding the admission will be final. If
...
/*.login-box-body, .register-box-body {
	...
	.box button{
	  ...
	  <script>
	  function change_per(){
	  	var x = parseFloat($('#txtfinalpercentage').val()) ;
	  	var y = x.toFixed(2);
	  	$('#txtfinalpercentage').val(y);
	  }
