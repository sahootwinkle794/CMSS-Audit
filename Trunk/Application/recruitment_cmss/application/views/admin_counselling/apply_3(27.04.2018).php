			...
			<div class="col-lg-12" style="padding-top:0px;">
				...
				<?php } 
						...
						?>
							<a href="<?=base_url()?>Admin_apply/<?=$file_name?>/ins/<?=$ins?>"><img src="<?=base_url()?>public/assets/images/studentdetails.png" /></a>
							<img src="<?=base_url()?>public/assets/images/documentupload.png" />
							<a href="<?=base_url()?>Admin_apply/apply_4/ins/<?=$ins?>"><img src="assets/img/payment.png" /></a>	
						<?php	
						}
					?>
					<div class="panel panel-primary panel-document">
...
?>
										...
										<tr style="text-align:center;">
											...
											<td style="text-align:left;">
												<input type="file" id="file<?=$row['document_type_code']?>" name="fileDocument[]" style="width:80%" class="form-control"  onchange = "showImage('<?=$row['document_type_code']?>',<?=$row['document_preview_width']?>,<?=$row['document_preview_height']?>,<?=$row['document_size_in_kb']?>);" />
...
?>
									...
									<div class="form-group">
										<div class="col-lg-offset-5 col-lg-3">
											<button type="submit" class="btn btn-primary" id="btndocumentUpload" name="btndocumentUpload" style="background:#9D426B;" <?php if($edit=='true'){ echo "onclick='return validate_edit();'"; } else { echo "onclick='return validate();'"; }?> >Save & Next</button>
										</div>
									</div>
									<?php }
                                    if($show == 1) { ?>
									<div class="form-group">
										<div class="col-lg-offset-5 col-lg-3">
											<button type="submit" class="btn btn-primary" id="btndocumentUploadEdit" name="btndocumentUploadEdit" style="background:#9D426B;"  onclick='return validate_edit();'>Save & Next</button>
										</div>
									</div>
									<?php } ?>
								  </form>
