					...
					<div class="panel panel-primary panel-document">
						...
						<div class="panel-body">
							<div class="col-lg-12" style="box-shadow: 0px 7px 20px -6px #090909; background-color: #F1F1F1;border: 1px solid rgb(255, 255, 255); border-radius: 5px; width: 100%;height: auto;padding: 21px;    margin-top: 5px;">
								...
								<form  class="md-form login-box-body" method="post" role="form" action="" id="frmApply" name="frmApply" enctype="multipart/form-data" style="background: #fff;padding: 20px;border-top: 0;color: #666;">
									<?php 
										...
										<div class="col-lg-4" style="padding-top: 10px;">
											<div class="form-group">
												<div class="input-group input-file" >
										    		<input type="file" class="form-control" style="width:85%;margin-left: 12px;"  id="file<?=$row['document_type_code']?>" name="fileDocument[]" onchange = "showImage('<?=$row['document_type_code']?>',<?=$row['document_preview_width']?>,<?=$row['document_preview_height']?>,<?=$row['document_size_in_kb']?>);"  />
										    	</div>	
											</div>
												...
												<?php 	
														...
														if($mode == "edit" || $appl_status == 'Document Uploaded' || $appl_status == 'Fee Paid' || $appl_status == 'Verified') 
													  	{ 
															...
															{ 
																echo "<img id='img".$row['document_type_code']."' style='' />"; 
															} 
														} 
														else 
														{ 
									...
									<?php 
										...
										<div class="form-group" style="margin-top: 10px;">
											<div class="col-lg-12">
												<button type="submit" class="btn btn-info btn-block" id="btndocumentUpload" name="btndocumentUpload" <?php if($edit=='true'){ echo "onclick='return validate_edit();'"; } else { echo "onclick='return validate();'"; }?>> <span class="glyphicon glyphicon-send" style="font-size:18px;"></span> Save & Next</button>
											</div>
										</div>
