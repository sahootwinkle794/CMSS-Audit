   ...
   <form method="post" action="" enctype="multipart/form-data">	
	...
	<input type="hidden" id="hidFileName" name="hidFileName" />
		<fieldset style="width:95%; margin: auto">
			...
			Step 1. <a style="color: blue;" href="<?php echo base_url() ?>adminCounselling/excel_program_branch_institute_seat">Download the template</a><br />
...
<?php
$output = '';
$output .= form_open_multipart('adminCounselling/save_programBranchInstituteSeat');
