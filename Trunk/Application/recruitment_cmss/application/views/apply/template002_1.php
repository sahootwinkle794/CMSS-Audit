								...
								<div>
									...
									<div class="col-lg-12" style="box-shadow: 0px 7px 20px -6px #090909; background-color: #F1F1F1;border: 1px solid rgb(255, 255, 255); border-radius: 5px; width: 100%;height: auto;padding: 21px;margin-top: 20px;">
										...
										<div class="row" style="margin-top: 20px;">
											...
											<div class="col-lg-6">
												<div class="form-group">
													<label for="" class="col-lg-5" style="m">&nbsp;&nbsp;<i class="fa fa-birthday-cake" aria-hidden="true" style="color:#E4791A"></i> Age (as on 01-12-2018)</label>
													<div class="col-lg-7">
											...
											<div  class="row"  style="margin-top: 20px;">
												<div class="col-lg-6">
													<div class="form-group">
														...
														<div class="col-lg-7">
															<input type="text" class="form-control test" id="txtidproof" name="txtidproof" onkeypress="return isNumberKey(event)"  placeholder="Enter Aadhaar Number " maxlength="12"  value="<?=$id_proof_number?>" data-placement="top" data-toggle="tooltip" title=" Enter ID Proof Number " <?php echo $show==1?'disabled':''; ?>>
														</div>
													</div>
												</div>
												<div class="col-lg-6">
												...
												<div class="col-lg-6">
													<div class="form-group">
														...
														<div class="col-lg-7">
															...
															<input type="text" class="form-control test" value="<?=$stateCode?>" data-placement="top" data-toggle="tooltip" title="State" <?php echo $show==1?'disabled':''; ?> disabled>
														</div>
													</div>
												</div>
												<div class="col-lg-6">
											...
											<div class="row"  style="margin-top: 20px;">
												...
												<div class="col-lg-6">
													<div class="form-group">
														...
														<div class="col-lg-7">
															<input type="text" class="form-control" name="txtPresentPost" id="txtPresentPost" onchange="uncheck();" onkeypress="return isAlphaKey(event)"   onkeyup="changeCase(this)" maxlength="80" value="<?=$txtPresentPost?>" <?php echo $show==1?'disabled':''; ?>>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="row"  style="margin-top: 20px;">
												<div class="col-lg-6">
													<div class="form-group">
														...
														<div class="col-lg-7">
															<input type="text" class="form-control" name="city_name" value="<?=$city_name?>" onchange="uncheck();" onkeypress="return isAlphaKey(event)"   onkeyup="changeCase(this)" maxlength="80" id="city_name" <?php echo $show==1?'disabled':''; ?>>
														</div>
													</div>
												</div>
											...
											<div class="row" style="margin-top: 20px;">
												<div class="col-lg-6">
													<div class="form-group">
														<label for="" class="col-lg-5" style="    padding-right: 35px;"><i style="color:red;font-size:18px;">*</i> City</label>
														<div class="col-lg-7">
															<input type="text" class="form-control" name="city_name1" id="city_name1" onkeypress="return isAlphaKey(event)"  value="<?=$city_name1?>" onkeyup="changeCase(this)" maxlength="80" <?php echo $show==1?'disabled':''; ?>>
														</div>
													</div>
												</div>
