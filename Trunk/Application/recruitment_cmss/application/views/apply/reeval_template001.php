												...
												<div class="form-group">
													...
													<div class="col-lg-7">
														<label class="radio-inline">
															<input type="radio" name="radiomaritalstatus" id="radioMaritalStatusYES" value="YES" <?php if($radiomaritalstatus=="YES") { echo "checked"; } ?> <?php echo $show==1?'disabled':''; ?>> Married 
														</label>
														<label class="radio-inline">
															<input type="radio" name="radiomaritalstatus" id="radioMaritalStatusNO" value="NO" <?php if($radiomaritalstatus=="NO") { echo "checked"; } ?> <?php echo $show==1?'disabled':''; ?>> Unmarried 
														</label>
													</div>
												</div>
											</div>
