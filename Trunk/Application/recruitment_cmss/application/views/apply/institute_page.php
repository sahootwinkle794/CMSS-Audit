...
<style>
	.postdtl{
		background: url(<?php echo base_url() ?>upload/image/background.svg);
...
<!--<section style="min-height: 400px;padding-top: 105px;">-->
	<div class="row">
		<div class="col-md-12"> 
			...
			<div class="row">
	       		<div class="col-lg-9 col-md-9 col-xs-12 fpad prog" style="">
												...
												?>
											        ...
											        <div id="collapse_<?=$program_code?>" class="panel-collapse collapse">
												        ...
												        <div class="col-sm-3 col-xs-12 smpl-step-step disabled">           
												            ...
												            <?php if($program['appl_status'] == 'Student Details Submitted' || $program['appl_status'] == 'Document Uploaded'||$program['appl_status'] == 'Fee Paid' || $program['appl_status'] == 'Verified' || $program['appl_status'] == 'Payment Updated' || $program['appl_status'] == 'Application Submitted')
												            {
												            ?>
												        ...
												        <div class="col-sm-3 col-xs-12 smpl-step-step disabled">          
												            ...
												            <?php if($program['appl_status'] == 'Document Uploaded'||$program['appl_status'] == 'Fee Paid' || $program['appl_status'] == 'Verified' || $program['appl_status'] == 'Payment Updated' || $program['appl_status'] == 'Application Submitted')
												            {
												            ?>
												            	<div class="progress back" >
													                <div class="progress-bar"></div>
												         ...
												         <div class="col-sm-3 col-xs-12 smpl-step-step disabled">          
												            ...
												            <?php if($program['appl_status'] == 'Fee Paid' || $program['appl_status'] == 'Verified' || $program['appl_status'] == 'Payment Updated' || $program['appl_status'] == 'Application Submitted')
												            {
												            ?>
												            	<div class="progress back" >
													                <div class="progress-bar"></div>
															...
															<h4 style="margin-left:5px;padding-right: 5px;font-size: 15px;">
												       		...
												       		<center>
												       		  ...
												       		  <?php  if($program['appl_status']=='Verified' || $program['appl_status']=='Application Submitted'){ ?>
															  ...
															  <?php }}elseif($program['appl_status']!='Verified' && $program['appl_status'] != 'Application Submitted' && $program['appl_status']!='' && strtotime($program['apply_end_date']) >= strtotime($now) ){ ?>
															...
															<?php }elseif( strtotime($program['action1_apply_start_date']) <= strtotime($now) && strtotime($program['action1_apply_end_date']) >= strtotime($now) && $program['appl_status'] != 'Application Submitted'){ ?>
				...
				<div class="col-lg-3 col-md-3 col-xs-12"style="margin-top: -2%;">
    
    				<div class="row-sm-12 row-xs-12 ins" style="" >
				       <div class="row-sm-4 row-xs-4" style="padding-left: 0;cursor: pointer;" >
				        <div  class="col-sm-12 col-xs-12 box-green">
							...
							<div  class="col-sm-10 col-xs-10">
									<p align="center" >आवेदन केलिए अनुदेश <br />Instruction For Filling <br />Application</p>
							</div>
				         </div>
				       </div>
				       ...
				       <div class="row-sm-4 row-xs-4" style="padding-left: 0; padding-right: 0;cursor: pointer" data-toggle="modal"  >
				            ...
				            <div  class="col-sm-12 col-xs-12 box-white">
				            	<h4 style="text-align: center;">Color Description of Post Details</h4>
								<!--<div class="hidden-xs hidden-sm col-md-2"></div> -->
								<div class="row">
									<div align="center" class="col-sm-2 col-xs-2 col-md-2">
										<div style="background-color: rgb(176, 173, 173);width: 20px;height: 20px;">

										</div>
									</div>
									<div  class="col-sm-10 col-xs-10 col-md-8">
										<p align="center">Already applied Post</p>
										
									</div>
								</div>
								<div class="row">
									<div align="center" class="col-sm-2 col-xs-2 col-md-2">
										<div style="background-color: rgb(217, 217, 217);width: 20px;height: 20px;">

										</div>
									</div>
									<div  class="col-sm-10 col-xs-10 col-md-8">
										<p align="center" style="">Non-applied Post</p>
									</div>
				            	</div>
				         	</div>
				       </div>
  ...
  <div class="modal-dialog modal-md modal-xs" role="document">
    <div class="modal-content newpassword">
      <div class="modal-header">
		...
		&times;</button>
		<center><h4 class="modaltext" id="myModalLabelHeader1"> CHANGE PASSWORD</h4></center>
	...
	<form class="form-horizontal" id="frmApply" name="frmApply">
      	<div class="modal-body">
			...
			<div class="form-group">
				<label for="inputname" class="col-lg-5 col-md-5 col-sm-5 col-xs-5 control-label lmb"><i style="color:red;font-size:15px;">*</i> Current Password</label>
				<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
					<div class="input-group newpas">
						...
						<input type="password" style="background: #ADDFE7;" class="form-control" id="txtoldPassword" name="txtoldPassword" placeholder="Current Password">
					</div>
			...
			<div class="form-group">
				<label for="" class="col-lg-5 col-md-5 col-sm-5 col-xs-5 control-label lmb"><i style="color:red;font-size:15px;">*</i> New Password</label>
				<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
					<div class="input-group newpas">
						<div class="input-group-addon ad" style="background: #ADDFE7;">
							<span class="input-group-text">
						...
						<input type="password" id="txtNewPassword" class="form-control tooltips" style="background: #ADDFE7;" name="txtNewPassword" placeholder="New Password" title="Enter New Password"></input>
					</div>
			...
			<div class="form-group">
				<label for="" class="col-lg-5 col-md-5 col-sm-5 col-xs-5 control-label lmb"><i style="color:red;font-size:15px;">*</i> Confirm Password</label>
				<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
					<div class="input-group newpas">
						<div class="input-group-addon ad" style="background: #ADDFE7;">
							<span class="input-group-text">
						...
						<input type="password" id="txtConfirmPassword" class="form-control tooltips" style="background: #ADDFE7;" name="txtConfirmPassword" placeholder="Confirm Password" title="Enter Confirm Password"></input>
					</div>
	    ...
	    <div class="modal-footer">
			...
			<button type="submit" class="btn btn-danger" id="btnChangePassword" name= "btnChangePassword" style="background: linear-gradient(180deg, #E48210 0%, #E47610 100%);">Change Password</button>
	    </div>
	</form>
    </div>
  </div>
...
<div class="modal fade" id="instuction_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="padding-top: 100px;">
		<div class="modal-dialog modal-lg modal-md modal-xs" style="" >
