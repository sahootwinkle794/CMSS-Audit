...
<!--**************START OF EMAIL ID AND Aadhaar NUMBER*********-->
											...
											<div  class="row"  style="margin-top: 20px;">
												<div class="col-lg-6">
													<div class="form-group">
														...
														<div class="col-lg-7">
															<select class="form-control" name="cmbNationality" id="cmbNationality" value="IND" <?php echo $show==1?'disabled':''; ?>>
																<?php
											...
											<div  class="row" style="margin-top: 20px;">
												<div class="col-sm-6">
													<div class="form-group">
														...
														<div class="col-lg-7">
															<label class="radio-inline">
																<input type="radio"  name="radiobelong" id="radiobelong" value="NO" <?php if($radiobelong=="NO") { echo "checked"; } ?> <?php echo $show==1?'disabled':''; ?> onclick="hide('belongsto');"> NO
															</label>
															<label class="radio-inline">
																<input type="radio" name="radiobelong" id="radiobelong" value="YES" <?php if($radiobelong=="YES") { echo "checked"; } ?> <?php echo $show==1?'disabled':''; ?> onclick="show('belongsto');"> YES
															</label>
														</div>
													</div>
												</div>
							...
							<!-- 					<div class="col-sm-6" id="belongsto" style="padding-top: 10px;" <?php if($radiobelong=="YES") { echo ""; } else { echo 'hidden'; }?> >
														...
														<div class="form-group">
															...
															<div class="col-lg-7">
																<select name="cmbNorthState" id="cmbNorthState" class="form-control" <?php echo $show==1?'disabled':''; ?>>
									...
									<!-- <div class="col-lg-12" style="box-shadow: 0px 7px 20px -6px #090909; background-color: #F1F1F1;border: 1px solid rgb(255, 255, 255); border-radius: 5px; width: 100%;height: auto;padding: 21px;    margin-top: 35px;">
										...
										<div class="col-sm-12" id="employer_id" style="background: #fff; padding-top: 10px;" <?php if($is_employed=="YES") { echo ""; } else { echo 'hidden'; }?> >
												...
												<table class=" col-sm-12 table">
													...
													<tbody>
														<tr>
															<td><div class="form-group"><input type="text" class="form-control " name="Employer_address" onkeyup="changeCase(this)" maxlength="99" value="<?=$employer_add?>" <?php echo $show==1?'disabled':''; ?>></div></td>
															<td><div class="form-group"><input type="text" class="form-control " name="Employer_from" id="Employer_from" value="<?=$employer_from?>" <?php echo $show==1?'disabled':''; ?> readonly></div></td>
															<td><div class="form-group"><input type="text" class="form-control " name="Employer_to" id="Employer_to" value="<?=$employer_to?>" <?php echo $show==1?'disabled':''; ?> readonly></div></td>
														</tr>
														...
														<table  class="table table-bordered table-striped">
															...
															<?php
																...
																<tr>
																	...
																	<td style="width: 15%"><div class="form-group"><input type="text" class="form-control input-sm" id="txtYear<?=$sl_no?>" name="txtYear<?=$sl_no?>" onkeypress="return isNumberKey(event)" maxlength="4"   value="<?php echo ${'txtYear'.$sl_no} == 'NULL'?'':${'txtYear'.$sl_no}; ?>" <?php echo $show==1?'disabled':''; ?> /></div></td>
																	<td style="width: 20%"><div class="form-group"><input type="text" class="form-control input-sm" id="txtBoard<?=$sl_no?>" name="txtBoard<?=$sl_no?>" value="<?=${'txtBoard'.$sl_no}?>" <?php echo $show==1?'disabled':''; ?> onkeyup="changeCase(this)" maxlength="50"/></div></td>
																	
																	
																	<td style="width: 15%"><div class="form-group"><input type="text" class="form-control input-sm" id="txtMS<?=$sl_no?>" name="txtMS<?=$sl_no?>" value="<?php echo ${'txtMS'.$sl_no} == 'NULL'?'':${'txtMS'.$sl_no}; ?>" onkeypress="return isNumberKey(event)" onblur="calculatePercentage(<?=$sl_no?>)"  <?php echo $show==1?'disabled':''; ?>/></div></td>
																	<td style="width: 15%"><div class="form-group"><input type="text" class="form-control input-sm" id="txtFM<?=$sl_no?>" name="txtFM<?=$sl_no?>" value="<?php echo ${'txtFM'.$sl_no} == 'NULL'?'':${'txtFM'.$sl_no}; ?>" onkeypress="return isNumberKey(event)" onblur="calculatePercentage(<?=$sl_no?>)"  <?php echo $show==1?'disabled':''; ?>/></div></td>
