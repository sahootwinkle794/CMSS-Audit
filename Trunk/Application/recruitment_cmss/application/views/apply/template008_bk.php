...
<script type="text/javascript">
	function show() { document.getElementById('employer_id').style.display = 'block';}
	function hide() { document.getElementById('employer_id').style.display = 'none';}
</script>
...
<div class="container-fluid" style="margin-top: 36px; padding-bottom: 50px;">
	...
	<div class="row" style="background-color: #FCCC3A;">
		<div class="col-sm-1 col-md-1 col-sm-1 col-xs-1" style="margin-top: 30px;">
					...
					<form   action="" method="post" id="frmApply" name="frmApply">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<div class="col-sm-4">
												...
												<input type="text" class="form-control"    name="center_name1" <?php echo $show==1?'disabled':''; ?>/>
												<input type="text" class="form-control"    name="center_code1" <?php echo $show==1?'disabled':''; ?>/>
											</div>

											<div class="col-sm-4">
												<label>2nd Prefernce</label>
												<input type="text" class="form-control"    name="center_name2" <?php echo $show==1?'disabled':''; ?>/>
												<input type="text" class="form-control"    name="center_code2" <?php echo $show==1?'disabled':''; ?>/>
											</div>

											<div class="col-sm-4">
												<label>3rd Prefernce</label>
												<input type="text" class="form-control"    name="center_name3" <?php echo $show==1?'disabled':''; ?>/>
												<input type="text" class="form-control"    name="center_code3" <?php echo $show==1?'disabled':''; ?>/>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="col-lg-12" style="box-shadow: 0px 7px 20px -6px #090909; background-color: #F1F1F1;border: 1px solid rgb(255, 255, 255); border-radius: 5px; width: 100%;height: auto;padding: 21px;margin-top: 20px;">
							...
							<div  class="row" style="margin-top: 20px;">
								<div class="col-lg-6">
									<div class="form-group" >
										...
										<div class="col-lg-7">
											...
											<label class="radio-inline">
												<input type="radio" name="radiogender" id="radiofemale" value="F" <?php if($radiogender=="T") { echo "checked"; } ?> <?php echo $show==1?'disabled':''; ?>> Other
											</label>
								...
								<div class="col-lg-6">
									<div class="form-group" >
										<label for="" class="col-lg-5 " ><i class="fa fa-wheelchair" aria-hidden="true" style="color:#E4791A";></i> Physically Challenged?</label>
										<div class="col-lg-7">
											<label class="radio-inline">
							...
							<!--**************END OF GENDER AND PHYSICAL FITNESS*********-->
											...
											<div  class="row" style="margin-top: 20px;">
												<div class="col-lg-12">
													<div class="form-group">
														<label for="" class="col-lg-5" style=""><i class="fa fa-map-marker" aria-hidden="true" style="color:#E4791A"></i> Whether candidate belongs to North East Region ?</label>
														<div class="col-lg-7">
															<label class="radio-inline">
											...
											<div class="row">
												<div class="col-lg-6">
													<div class="form-group">
														...
														<div class="col-lg-7">
															<input type="text" class="form-control" name="cand_name" id="cand_name"  <?php echo $show==1?'disabled':''; ?>>
														</div>
													</div>
												</div>
												<div class="col-lg-6">
													<div class="form-group">
														...
														<div class="col-lg-7">
															<input type="text" class="form-control" name="co_name" id="co_name"  <?php echo $show==1?'disabled':''; ?>>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="row">
												<div class="col-lg-6">
													<div class="form-group">
														...
														<div class="col-lg-7">
															<input type="text" class="form-control" name="city_name" id="city_name" <?php echo $show==1?'disabled':''; ?>>
														</div>
													</div>
												</div>
											...
											<div class="row" style="margin-top: 20px;">
												...
												<div class="col-lg-6">
													<div class="form-group">
														...
														<div class="col-lg-7">
															<input type="Number" class="form-control" name="phone_no" id="phone_no"  <?php echo $show==1?'disabled':''; ?>>
														</div>
													</div>
												</div>
												<div class="col-lg-6">
										...
										<div class="col-lg-12" style="box-shadow: 0px 7px 20px -6px #090909; background-color: #F1F1F1;border: 1px solid rgb(255, 255, 255); border-radius: 5px; width: 100%;height: auto;padding: 21px;    margin-top: 35px;">
											...
											<div class="row">
												<div class="form-group">
													<div class="col-sm-8">
														<input type="checkbox" id="chksameasresidential" name="chksameasresidential" value="Y"   <?php if($chksameasresidential=="Y") { echo "checked"; } ?> <?php echo $show==1?'disabled':''; ?>> 
											...
											<div class="row">
												<div class="col-lg-6">
													<div class="form-group">
														<label for="" class="col-lg-5" style="    padding-right: 35px;"><i class="fa fa-home" aria-hidden="true" style="color:#E4791A;"></i> Name</label>
														<div class="col-lg-7">
															<input type="text" class="form-control" name="cand_name1" id="cand_name1"  <?php echo $show==1?'disabled':''; ?>>
														</div>
													</div>
												</div>
												<div class="col-lg-6">
													<div class="form-group">
														<label for="" class="col-lg-5 " ><i style="color:red;font-size:18px;">*</i> C/O</label>
														<div class="col-lg-7">
															<input type="text" class="form-control" name="co_name1" id="co_name1"  <?php echo $show==1?'disabled':''; ?>>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="row">
												<div class="col-lg-6">
													<div class="form-group">
														<label for="" class="col-lg-5 " ><i style="color:red;font-size:18px;">*</i> Locality/Street Name</label>
														<div class="col-lg-7">
															<input type="text" class="form-control" name="txtPermenentLocality" id="txtPermenentLocality" value="<?=$txtPermenentLocality?>" <?php echo $show==1?'disabled':''; ?>>
														</div>
													</div>
												</div>
											...
											<div class="row">
												<div class="col-lg-6">
													<div class="form-group">
														<label for="" class="col-lg-5" style="    padding-right: 35px;"><i style="color:red;font-size:18px;">*</i> City</label>
														<div class="col-lg-7">
															<input type="text" class="form-control" name="city_name1" id="city_name1"  <?php echo $show==1?'disabled':''; ?>>
														</div>
													</div>
												</div>
											...
											<div class="row" style="margin-top: 20px;">
												...
												<div class="col-lg-6">
													<div class="form-group">
														<label for="" class="col-lg-5 " ><i style="color:red;font-size:18px;">*</i> Phone No</label>
														<div class="col-lg-7">
															<input type="Number" class="form-control" name="phone_no1" id="phone_no1"  <?php echo $show==1?'disabled':''; ?>>
														</div>
													</div>
												</div>
												<div class="col-lg-6">
									...
									<!-- <div class="col-sm-12">
									            <div class="col-sm-6">
												<label for="" class="control-label" ><i style="color:red;font-size:18px;">*</i> Wheather Employed : (Please tick in the appropriate box) <br>(if employed, no objection certificate from the employes has to be submitted)</label>
											</div>
											    
											    <div class="col-sm-4">
												
													<label class="radio-inline">
														<input type="radio" name="employed" id="employed" value="YES" <?php if($radiogender=="yes") { echo "checked"; } ?> <?php echo $show==1?'disabled':''; ?> onclick="show();"> Yes
													</label>
													<label class="radio-inline">
														<input type="radio" name="employed" id="employed" value="NO" <?php if($radiogender=="No") { echo "checked"; } ?> <?php echo $show==1?'disabled':''; ?> onclick="hide();"> No
													</label>

												</div>
											  </div>

										<div class="col-sm-12" id="employer_id" style="display: none; background: #fff; padding-top: 10px;">
											
												<table class=" col-sm-12 table">
													<thead>
														<tr>
															<th>Name & Address Of Employes</th>
															<th>From</th>
															<th>To</th>
														</tr>
													</thead>
													...
													<tbody>
														<tr>
															<td><input type="text" class="form-control" name="Employer_address" <?php echo $show==1?'disabled':''; ?>></td>
															<td><input type="text" class="form-control" name="Employer_from" <?php echo $show==1?'disabled':''; ?>></td>
															<td><input type="text" class="form-control" name="Employer_to" <?php echo $show==1?'disabled':''; ?>></td>
														</tr>

														<tr>
															<td><input type="text" class="form-control" name="Employer_address1" <?php echo $show==1?'disabled':''; ?>></td>
															<td><input type="text" class="form-control" name="Employer_from1" <?php echo $show==1?'disabled':''; ?>></td>
															<td><input type="text" class="form-control" name="Employer_to1" <?php echo $show==1?'disabled':''; ?>></td>
														</tr>
													</tbody>
												</table>
											</div>
									...
									<div class="col-lg-12" style="box-shadow: 0px 7px 20px -6px #090909; background-color: #F1F1F1;border: 1px solid rgb(255, 255, 255); border-radius: 5px; width: 100%;height: auto;padding: 21px;    margin-top: 35px;">
													...
													<div class="table-responsive">
														<table  class="table table-bordered table-striped">
															<tr>
																...
																<th style="text-align:center;">Name & Address Of the school/college From where Passed</th>
															...
															foreach($allQualifications as $row)
															{
																...
																<tr>
																	...
																	<td><div class="form-group"><input type="text" class="form-control input-sm" id="txtFM<?=$sl_no?>" name="txtFM<?=$sl_no?>" value="<?php echo ${'txtFM'.$sl_no} == 'NULL'?'':${'txtFM'.$sl_no}; ?>" onkeypress="return isNumberKey(event)"  <?php echo $show==1?'disabled':''; ?>/></div></td>
															...
															<tr>
																...
																<td><div class="form-group"><input type="text" class="form-control input-sm" id="txtFM4" name="txtFM4" value="<?php echo $txtFM4 == 'NULL'?'':$txtFM4; ?>" onkeypress="return isNumberKey(event)"   <?php echo $show==1?'disabled':''; ?>/></div></td>
										...
										<div class="row" style="margin-top: 20px;">
												...
												<div class="form-group">
													...
													<div class="col-lg-7">
														<input type="date" class="form-control" name="completion_date" id="completion_date"  <?php echo $show==1?'disabled':''; ?>>
													</div>
												</div>
                     ...
                     <div class="row" style="margin-top: 20px;">
										<div class="col-sm-12">
											...
											<div class="col-sm-3">
												...
												<input type="text" class="form-control" name="amount_paid" id="amount_paid"  <?php echo $show==1?'disabled':''; ?>>
											</div>

											<div class="col-sm-3">
												<label>Bank Draft No..</label>
												<input type="Number" class="form-control" name="draft_no" id="draft_no"  <?php echo $show==1?'disabled':''; ?>>
											</div>

											<div class="col-sm-3">
												<label>Dated</label>
												<input type="date" class="form-control" name="payment_date" id="payment_date"  <?php echo $show==1?'disabled':''; ?>>
											</div>

											<div class="col-sm-3">
												<label>Name Of the Bank</label>
												<input type="text" class="form-control" name="bank_name" id="bank_name"  <?php echo $show==1?'disabled':''; ?>>
											</div>
										</div>
