...
$txtPermanentPost = '';
$txtPermanentPanchayat = '';
$txtPermanentPanchyat = '';
$txtPermanentBlock = '';
$cmbPermanentState = '';
$cmbPermanentDist = '';
$txtPermanentPin = '';
...
{   
	...
	$txtHomedist = $row['district_code'];
	//$txtHomedist  = $row['home_district'];
	
	$relevantinfo = $row['relevantinfo'];
	$enclosuresdetails = $row['enclosuresdetails'];
	$txtOtherComp = $row['other_computer'];
	...
	$radioComputerEducation = $row['is_computer_education'];
	$radioComputerType = $row['is_computer_type'];
	...
	$txtphpercent   = $row['disability_percent'];
	$txtHomedist   = $row['district_code'];
...
foreach($present_communication_data as $row)
{
	...
	$txtPresentPanchyat = $row['panchayat'];
	$txtPresentBlock = $row['block'];
...
foreach($permanent_communication_data as $row)
{
	...
	$txtPermanentPanchyat = $row['panchayat'];
	$txtPermanentBlock = $row['block'];
...
function setSameAddress()
{
	var regex = /^([a-zA-Z0-9-\n\r \/.,();]+)$/;
	var regexPin = /^\d{6}$/;
	alert(document.getElementById("txtPresentPanchayat").value);
	if(document.getElementById("txtPresentLocality").value == '' || document.getElementById("city_name").value == '' || document.getElementById("txtPresentPost").value == '' || document.getElementById("txtPresentPanchayat").value == '' || document.getElementById("txtPresentBlock").value == '' || document.getElementById("cmbPresentState").value == '' || document.getElementById("cmbPresentDist").value == '' || document.getElementById("txtPresentPin").value == '')
	{
	...
	else if(regex.test(document.getElementById("txtPresentPanchayat").value ) == false)
	{
		toastr.error("Please enter valid Gram Panchayat");
		$('#chksameasresidential').prop('checked', false);
		return false;
	}
	else if(regex.test(document.getElementById("txtPresentBlock").value ) == false)
	{
		toastr.error("Please enter valid Block");
		$('#chksameasresidential').prop('checked', false);
		return false;
	}
	...
	else if(document.getElementById("chksameasresidential").checked)
	{
		...
		$('#frmApplicantDetails').data('bootstrapValidator').updateStatus('txtPermanentPanchayat', 'VALID',null);
		$('#frmApplicantDetails').data('bootstrapValidator').updateStatus('txtPermanentBlock', 'VALID',null);
		...
		document.getElementById("txtPermanentPanchayat").value=document.getElementById("txtPresentPanchayat").value;
		document.getElementById("txtPermanentBlock").value=document.getElementById("txtPresentBlock").value;
		...
		$('#txtPermanentPanchayat').attr('disabled', true);
		$('#txtPermanentBlock').attr('disabled', true);
	...
	else
	{
		...
		$('#txtPermanentPanchayat').removeAttr('disabled', false);
		$('#txtPermanentBlock').removeAttr('disabled', false);
		...
		$('#frmApplicantDetails').data('bootstrapValidator').updateStatus('txtPermenentPanchayat', 'NOT_VALIDATED',null).validateField('txtPermenentPanchayat');
		$('#frmApplicantDetails').data('bootstrapValidator').updateStatus('txtPermenentBlock', 'NOT_VALIDATED',null).validateField('txtPermenentBlock');
									...
									<div>
										...
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" style="padding: 0px;margin-top: 10px;">
											...
											<div  class="row"  style="margin-top: 20px;margin-left: -2%;">
												<div class="col-lg-6">
													<div class="form-group" >
														<label for="" class="col-lg-5 control-label"  ><i style="color:red;font-size:18px;">*</i> <i class="fa fa-venus-mars" aria-hidden="true" style="color:#E4791A;"></i> Marital Status</label>
														<div class="col-lg-7">
															<label class="radio-inline">
												...
												<div class="col-lg-6">
													<div class="form-group">
														<label for="" class="col-lg-5" style="m">&nbsp;&nbsp;<i style="color:red;font-size:18px;">*</i> <i class="fa fa-credit-card" aria-hidden="true" style="color:#E4791A"></i> District Where applicant is residing</label>
														<div class="col-lg-7">
															<input type="text" class="form-control " id="txtHomeDist" name="txtHomeDist" placeholder="Enter the district where applicant is originally residing" maxlength="20"  value="<?=$txtHomedist?>" data-placement="top" data-toggle="tooltip"  <?php echo $show==1?'disabled':''; ?>>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="row" id="divPH">
											<div class="col-lg-6">
												<div class="form-group">
													<label for="" class="col-lg-5"  >&nbsp;&nbsp; <i style="color:red;font-size:18px;">*</i> PWD Type</label>
													<div class="col-lg-7">
														<input class="form-control" type="text" name="cmbPH" id="cmbPH" value="<?=$txtphtype?>" <?php echo $show==1?'disabled':''; ?> />
													</div>
												</div>
											...
											<div class="col-lg-6">
												<div class="form-group">
													<label for="" class="col-lg-5"  >&nbsp;&nbsp; <i style="color:red;font-size:18px;">*</i> PWD Percentage</label>
													<div class="col-lg-7">
														<input class="form-control" type="text" name="txtPHPercent" id="txtPHPercent" value="<?=$txtphpercent?>" <?php echo $show==1?'disabled':''; ?> />
													</div>
												</div>
										...
										<!--</div>-->
											...
											<legend>Present Address </legend>
												...
												<div class="row"  style="margin-top: 20px;">
													<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
														<div class="form-group">
															<label for="" class="col-xs-12 col-sm-12 col-md-5 col-lg-5 col-xl-5" ><i style="color:red;font-size:18px;">*</i> Gram Panchayat </label>
															<div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 col-xl-7">
																<input type="text" class="form-control" name="txtPresentPanchayat" id="txtPresentPanchayat" onchange="uncheck();" onkeyup="changeCase(this)" maxlength="80" value="<?=$txtPresentPanchyat?>" <?php echo $show==1?'disabled':''; ?>>
															</div>
													...
													<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
														<div class="form-group">
															<label for="" class="col-xs-12 col-sm-12 col-md-5 col-lg-5 col-xl-5" style="    padding-right: 35px;">&nbsp;&nbsp;<i style="color:red;font-size:18px;">*</i> Block</label>
															<div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 col-xl-7">
																<input type="text" class="form-control" name="txtPresentBlock" id="txtPresentBlock" onchange="uncheck();"    onkeyup="changeCase(this)" maxlength="80" value="<?=$txtPresentBlock?>" <?php echo $show==1?'disabled':''; ?>>
															</div>
														</div>
													</div>
												</div>
											...
											<legend style="width: 20%;">Permanent Address</legend>
												...
												<div class="row"  style="margin-top: 20px;">
														...
														<div class="col-lg-6">
															<div class="form-group">
																...
																<div class="col-lg-7">
																	...
																	<input type="text" class="form-control" name="txtPermanentPost"    id="txtPermanentPost" onkeyup="changeCase(this)" maxlength="80" value="<?=$txtPermanentPost?>" <?php echo $show==1?'disabled':''; ?> >
																</div>
															</div>
														</div>
													...
													<div class="row"  style="margin-top: 20px;">
														<div class="col-lg-6">
															<div class="form-group">
																<label for="" class="col-lg-5 " ><i style="color:red;font-size:18px;">*</i> Gram Panchayat </label>
																<div class="col-lg-7">
																	<input type="hidden" name="hidPermanentPanchayat" id="hidPermanentPanchayat" value="<?=$txtPermanentPanchyat?>" />
																	<input type="text" class="form-control" name="txtPermanentPanchayat" id="txtPermanentPanchayat" onkeyup="changeCase(this)" maxlength="80" value="<?=$txtPermanentPanchyat?>" <?php echo $show==1?'disabled':''; ?>>
																</div>
															</div>
														</div>
														...
														<div class="col-lg-6">
															<div class="form-group">
																<label for="" class="col-lg-5" style="padding-right: 35px;">&nbsp;&nbsp;<i style="color:red;font-size:18px;">*</i> Block</label>
																<div class="col-lg-7">
																	<input type="hidden" name="hidPermanentBlock" id="hidPermanentBlock" value="<?=$txtPermanentBlock?>" />
																	<input type="text" class="form-control" name="txtPermanentBlock"    id="txtPermanentBlock" onkeyup="changeCase(this)" maxlength="80" value="<?=$txtPermanentBlock?>" <?php echo $show==1?'disabled':''; ?> >
																</div>
															</div>
														</div>
							...
							<form action="" method="post" id="frmAcademicInfo" name="frmAcademicInfo">
								...
								<fieldset>
									...
									<div class="row">
											...
											<div class="table-responsive">
												...
												<table  class="table table-bordered table-striped">
													...
													<tr>
														...
														<th style="text-align:center;" width="15%">Year of Passing</th>
														<th style="text-align:center;" width="10%">Board/University</th>
														<!--<th style="text-align:center;" width="10%">Subject</th>-->
														<th style="text-align:center;" width="10%">Total marks (Excluding 4th Optional mark)</th>
														<th style="text-align:center;" width="10%">Mark Secured (Excluding 4th Optional mark)</th>
														<th style="text-align:center;" width="10%">% of Marks</th>
													</tr>
													</thead>
													<tbody>
													<?php
														...
														<tr id="<?php echo $row['qualification_code']; ?>">
															...
															<td><div class="form-group"><input type="text" data-bv-callback-callback="true" data-bv-callback-message="true" class="form-control input-sm" id="txtFM<?=$sl_no?>" onkeypress="return isNumberKey(event)" onblur="calculate_percentage(<?=$sl_no?>)" onchange="calculate_percentage(<?=$sl_no?>)" name="txtFM<?=$sl_no?>" <?php echo $show==1?'disabled':''; ?> maxlength="5"  value="<?php echo ${'txtMS'.$sl_no} == 'NULL'?'':${'txtMS'.$sl_no}; ?>" /></div></td>
															<td><div class="form-group"><input type="text" data-bv-callback-callback="true" data-bv-callback-message="true" class="form-control input-sm" id="txtMS<?=$sl_no?>" onkeypress="return isNumberKey(event)" onblur="calculate_percentage(<?=$sl_no?>)" onchange="calculate_percentage(<?=$sl_no?>)" name="txtMS<?=$sl_no?>" <?php echo $show==1?'disabled':''; ?> maxlength="5"  value="<?php echo ${'txtFM'.$sl_no} == 'NULL'?'':${'txtFM'.$sl_no}; ?>" /></div></td>
															...
															<td><div class="form-group"><input type="text" data-bv-callback-callback="true" data-bv-callback-message="true" class="form-control input-sm" id="txtPercent<?=$sl_no?>" readonly onkeypress="return isNumberKey(event)" onclick="calculate_percentage(<?=$sl_no?>)"  name="txtPercent<?=$sl_no?>" <?php echo $show==1?'disabled':''; ?> maxlength="5"  value="<?php echo ${'txtPercent'.$sl_no} == 'NULL'?'':${'txtPercent'.$sl_no}; ?>" /></div></td>
										...
										<div  class="row"  style="margin-top: 20px;">
											<div class="col-lg-8">
												<div class="row">
													<!--<div class="col-lg-8">-->
													<div class="form-group" >
														<label for="" class="col-lg-6 " >&nbsp;&nbsp;<i style="color:red;font-size:18px;">*</i> <i class="fa fa-computer" aria-hidden="true" style="color:#E4791A";></i> Computer Eduction</label>
														<div class="col-lg-6" >
															<label class="radio-inline">
																<input type="radio"  name="radioComputerEducation" id="radioComputerEducationO" value="'O' Level" <?php if($radioComputerEducation=="'O' Level") { echo "checked"; } ?> <?php echo $show==1?'disabled':''; ?>> 'O' Level
															</label>
															<label class="radio-inline">
																<input type="radio" name="radioComputerEducation" id="radioComputerOth" value="Other" <?php if($radioComputerEducation=="Other") { echo "checked"; } ?> <?php echo $show==1?'disabled':''; ?>> Other
															</label>
														</div>
													</div>
												</div>
										...
										<div class="row" id="divComp" hidden style="margin-top:1%">
											<div class="col-lg-6">
												<div class="form-group">
													<label for="" class="col-lg-5"  >&nbsp;&nbsp; <i style="color:red;font-size:18px;">*</i> Other Computer Course</label>
													<div class="col-lg-7">
														<input class="form-control" type="text" name="txtOtherComp" id="txtOtherComp" value="<?=$txtOtherComp?>" <?php echo $show==1?'disabled':''; ?> />
													</div>
												</div>
										...
										<div class="row" style="margin-top:1%">
											<div class="col-lg-6">
												<div class="row">
													<!--<div class="col-lg-8">-->
													<div class="form-group" >
														<label for="" class="col-lg-8 " >&nbsp;&nbsp;<i style="color:red;font-size:18px;">*</i> <i class="fa fa-computer" aria-hidden="true" style="color:#E4791A";></i> Ability to type Odia Language in Computer</label>
														<div class="col-lg-4" >
															<label class="radio-inline">
																<input type="radio"  name="radioComputerType" id="radioComputerTypeYes" value="YES" <?php if($radioComputerType=="YES") { echo "checked"; } ?> <?php echo $show==1?'disabled':''; ?>> YES
															</label>
															<label class="radio-inline">
																<input type="radio" name="radioComputerType" id="radioComputerTypeNo" value="NO" <?php if($radioComputerType=="NO") { echo "checked"; } ?> <?php echo $show==1?'disabled':''; ?>> NO
															</label>
														</div>
													</div>
												</div>
							...
							<div class="tab-pane" id="info_tab"> 
								...
								<fieldset>
								 		...
								 		<div class="form-group">
											...
											<button class="btn btn-danger" id="btnPromoter" type="button" <?php echo $show==1?'disabled':''; ?>>Add</button>
												<table id="dtblPromoter" class="table table-bordered table-striped">
													<thead>
												    <tr>																		
														<th rowspan="2" style="text-align:center;">Employer(Name & address of the Organisation)</th>
														<th rowspan="2" style="text-align:center;">Post Held</th>
														<th colspan="3" style="text-align:center;">Experience</th>
														<th rowspan="2" style="text-align:center;">Nature of Assignment</th>
														<th rowspan="2" style="text-align:center;">Pay Scale/ Band</th>
									...
									<div class="col-sm-12 form-group" >
										...
										<button class="btn-warning" type="button" name="btnCalculateTotalExperience" id="btnTotalExperince" onclick="calculate_total_experience()">Calculate Total Experience</button></button>
								 	</div>
									<div class="col-sm-12 form-group" >
								        <div class="col-sm-7">
										...
										<div class="col-sm-5">
											...
											<input  type="text" id="txtTotalExperience" name="txtTotalExperience" value="<?=$txtTotalExperience?>" readonly onblur="calculate_total_experience()" value="" readonly/>
										</div>
									</div>
								</fieldset><br /><br />
								</div>
									...
									<div class="row">
										<div class="form-group">
											<div class="col-sm-12" align="justify">
												...
												I do hereby declare that the information furnished above are true to the best of my knowledge and belief. I will be liable for false information and misrepresentation of facts foundif any susequently.
											</div>
										</div>
									</div>
									<br />
...
<script src="<?php echo base_url(); ?>public/assets/js/template001.js?v=<?= rand()?>"></script>
...
function uncheck(){
	...
	$('#txtPermanentPanchayat').attr('disabled', false);
	$('#txtPermanentBlock').attr('disabled', false);
