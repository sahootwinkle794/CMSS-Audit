						...
						<div style="border-radius:0px;border: 0px inset;padding-left:20px;padding-right:20px;padding-top:0px;">
						  <form class="form-horizontal" method="post" role="form" id="frmApply" name="frmApply" >
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<input type="text" class="form-control" id="txtChallanAmount" name="txtChallanAmount" placeholder="Amount" value="<?php echo $noamount==1?'0.00':$amount; ?>" disabled >
								</div>
								...
								<?php }
										...
										?>								
												<div class="form-group">
													<label for="" class="col-sm-2 control-label" style="align:left;">Payment Mode :</label>
													<div class="col-sm-3">
														<input  type="text" name="txtPayMode" class="form-control" value="<?=$deposit_mode?>" disabled/>
													</div>
												</div>
												<div class="form-group">
													<label for="" class="col-sm-2 control-label" style="align:left;">Transaction No :</label>
													<div class="col-sm-3">
														<input  type="text" name="txtPayNo" class="form-control" value="<?=$row6['money_receipt_no']?>" disabled/>
													</div>
												</div>
												<div class="form-group">
													<label for="" class="col-sm-2 control-label" style="align:left;">Payment Date :</label>
													<div class="col-sm-3">
														<input  type="text" name="txtPayDate" class="form-control" value="<?=$row6['depositdate']?>" disabled/>
													</div>
												</div>
										<?php										
										}
