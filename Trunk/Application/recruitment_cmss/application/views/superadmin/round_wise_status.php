...
<div class="content-wrapper">
	<!--<div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Round Wise Status</h1>
        </div>
	</div>-->
					...
					<div class="panel-body box box-default">
						<div style="border-radius:0px;border: 0px inset;padding-left:20px;padding-right:20px;padding-top:0px;">
							...
							<div class="col-lg-12 page-header">
								<label for="" class="col-sm-1 control-label"><i style="color:red;font-size:15px;">*</i> Post:</label>
								<div class="col-sm-3">
									<select class="form-control"  name="cmbProgramFilter" title="Select Post" id="cmbProgramFilter">
									</select>
								</div>
								<button type="button" class="btn btn-warning" name="btnUpdate" id="btnUpdate" /><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;Change Status</button>
							</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="form-horizontal" role="form"  id="frmAddProgram" name="frmAddProgram">
							...
							<div class="form-group">
								<label for="" class="col-sm-2 control-label">Counselling Registration Period</label>
								<div class="col-sm-10">
							...
							<div class="form-group">
								<label for="" class="col-sm-2 control-label">Provisional Allotment Period</label>
								<div class="col-sm-10">
									<input type="text"  class="form-control tooltips timepicker" id="txtAppDate" name="txtAppDate"  title="Apply Date">
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-2 control-label">Choice Filling and Locking</label>
								<div class="col-sm-10">
...
<script type="text/javascript" language="javascript" src="<?php echo base_url(); ?>public/assets/js/superadmin/round_wise_status.js"></script>
