		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:0px;padding-right: 2%;">
			...
			{ 
				...
				{ 
					...
					<a href="<?=base_url()?>Admin_apply/apply_3/ins/<?=$institute_code?>"><img src="<?=base_url()?>public/assets/images/documentupload1.png" /></a>
				...
				{ 
					...
					<img src="<?=base_url()?>public/assets/images/studentdetails.png" />
					<a href="<?=base_url()?>Admin_apply/apply_3/ins/<?=$institute_code?>" ><img src="<?=base_url()?>public/assets/images/documentupload.png" /></a>
						...
						<div class="col-lg-12" style="box-shadow: 0px 7px 20px -6px #090909; background-color: #F1F1F1;border: 1px solid rgb(255, 255, 255); border-radius: 5px; width: 100%;height: auto;padding: 21px;margin-top: 5px;">
							...
							<!--************START OF NAME ROW**********--> 
							             ...
							             <div class="row">
								               <div class="col-lg-12">
													<div class="form-group">
														<label for="" class="col-lg-5" ><i style="color:red;font-size:18px;">*</i> Application For :</label>
														<div class="col-lg-7">
															<!--<select class="form-control" name="master_name" id="master_name"   >
															...
															<input type="text" class="form-control" id="txtCourse" name="txtCourse" readonly="readonly"  value="<?= $course_name ?>" >
														</div>
													</div>
												</div>
											</div>	
												...
												<div class="form-group">
													...
													<div class="col-lg-7">
														<label class="radio-inline">
															<input type="radio" name="radioJEE" id="radioJEESouth" value="SOUTH" <?php if($radioJEE=="SOUTH") { echo "checked"; } ?> > 17th June 2018
														</label>
														<label class="radio-inline" style="margin-left: 300px;">
															<input type="radio" name="radioJEE" id="radioJEECommon" value="COMMON" <?php if($radioJEE=="COMMON") { echo "checked"; } ?> > 8th July 2018
														</label>
													</div>
												</div>
												<div>
							...
							<div class="row" style="margin-top: 20px;" id="COMMON">	
								...
								<div class="col-lg-12">
									<!--<div class="form-group">-->
										<label for="" class="col-lg-4" style="text-align:left; " ><i style="color:red;font-size:18px;">*</i> Choice Of CIPET Center For Admission :</label>
										<div class="col-sm-8">
											<div class="col-sm-4 form-group">
												<label>Choice 1</label>

												<select class="form-control" name="center_namech1" id="center_name1COMMON" >
											...
											<div class="col-sm-4 form-group">
												...
												<select class="form-control" name="center_namech2" id="center_name2COMMON" >
													<option value="">Select Preference</option>									 
												</select>
											...
											<div class="col-sm-4 form-group">
												...
												<select class="form-control" name="center_namech3" id="center_name3COMMON">
													<option value="">Select Preference</option>									 
												</select>
							...
							<div class="row" style="margin-top: 20px;display: none;" id="SOUTH">	
									...
									<!--<div class="form-group">-->
										...
										<div class="col-sm-8">
											<div class="col-sm-4 form-group">
												...
												<select class="form-control" name="center_name1" id="center_name1SOUTH"   >
													<option value="">Select Preference</option>							 
												</select>
											...
											<div class="col-sm-4 form-group">
												...
												<select class="form-control" name="center_name2" id="center_name2SOUTH"   >
													<option value="">Select Preference</option>									 
												</select>
												<!-- <input type="text" class="form-control"    name="center_name2" value="<?=$center_name2?>" /> 
												<input type="text" class="form-control"    name="center_code2" value="<?=$center_code2?>" />-->
											...
											<div class="col-sm-4 form-group">
												<label>Choice 3</label>
												<select class="form-control" name="center_name3" id="center_name3SOUTH"   >
													<option value="">Select Preference</option>									 
												</select>
												<!-- <input type="text" class="form-control"    name="center_name3" value="<?=$center_name3?>" /> 
												<input type="text" class="form-control"    name="center_code3" value="<?=$center_code3?>" />-->
...
<!--**************START OF EMAIL ID AND Aadhaar NUMBER*********-->
											<div  class="row"  style="margin-top: 20px;">
												<div class="col-lg-12">
													<div class="form-group">
														<label for="" class="col-lg-9" style="m"><i style="color:red;font-size:18px;">*</i>&nbsp;&nbsp;<i class="fa fa-credit-card" aria-hidden="true" style="color:#E4791A"></i> Do You Have Any Of The ID Proof (Aadhaar / Driving Licence / Passport / Student ID Card / Bank Passbook )</label>
														<div class="col-lg-3">
															<label class="radio-inline">
																<input type="radio" name="radioID" id="radioIDYes" value="Yes" <?php if($radioID=="Yes") { echo "checked"; } ?> > Yes
															</label>
															<label class="radio-inline">
																<input type="radio" name="radioID" id="radioIDNo" value="No" <?php if($radioID=="No") { echo "checked"; } ?> > No
															</label>
														</div>
													</div>
												</div>
											...
											<div  class="row"  style="margin-top: 20px;">
												<div class="col-lg-12">
													<div class="form-group">
														...
														<div class="col-lg-3">
															<label class="radio-inline">
																<input type="radio" name="NorthEast" id="NorthEastYes" value="Yes" <?php if($NorthEast=="Yes") { echo "checked"; } ?> > Yes
															</label>
															<label class="radio-inline">
																<input type="radio" name="NorthEast" id="NorthEastNo" value="No"  <?php if($NorthEast=="No") { echo "checked"; } ?> > No
															</label>
														</div>
													</div>
												</div>
											...
											<div  class="row"  style="margin-top: 20px;">
													<!-- 	<div class="col-lg-6">
													<div class="form-group">
														<label for="" class="col-lg-5" style=""><i style="color:red;font-size:18px;">*</i> <i class="fa fa-male" aria-hidden="true" style="color:#E4791A"></i> Father/Guardian's Name</label>
														<div class="col-lg-7">
															<input type="text" class="form-control" id="txtFatherName" name="txtFatherName" placeholder="Enter Father Name" maxlength="80"  onkeyup="changeCase(this)"  value="<?=strtoupper($txtFatherName)?>" >
														</div>
													</div>
												</div> -->
												...
												<div class="col-lg-6">
													<div class="form-group">
														<label for="" class="col-lg-5" style="m">&nbsp;&nbsp;<i class="fa fa-credit-card" aria-hidden="true" style="color:#E4791A"></i>&nbsp;&nbsp; Candidate Aadhaar No.</label>
														<div class="col-lg-7">
															<input type="text" class="form-control test" id="txtUid" name="txtUid" placeholder="Enter Aadhaar No" maxlength="12" onkeypress="return isNumberKey(event)"   value="<?=$txtUid?>" data-placement="top" data-toggle="tooltip" title="Aadhaar No must be a digit. Ex:123456789012" >
														</div>
													</div>
												</div>
                             ...
                             <!--  <div  class="row"  style="margin-top: 20px;">
												...
												<div class="col-lg-6">
													<div class="form-group">
														...
														<div class="col-lg-7">
															<input type="text" class="form-control test" id="FathersProfession" name="FathersProfession" placeholder="Enter Fathers Profession" maxlength="80"  onkeyup="changeCase(this)" data-placement="top" data-toggle="tooltip" value="<?=$FathersProfession;?>" title="" >
														</div>
													</div>
												</div>
													...
													<div class="form-group">
														...
														<div class="col-lg-7">
															<input type="text" class="form-control" id="FathersIncome" name="FathersIncome" onkeypress="return isNumberKey(event)" placeholder="Enter Fathers Income"   value="<?=$FathersIncome;?>" maxlength="8" data-placement="top" data-toggle="tooltip" title="Your Father's Annual Income. Ex:20000000" >
														</div>
													</div>
												</div>
											</div> -->
							...
							<div  class="row" style="margin-top: 20px;">
								...
								<div class="col-lg-8">
									<div class="form-group" >
										<label for="" class="col-lg-6 " ><i style="color:red;font-size:18px;">*</i> <i class="fa fa-wheelchair" aria-hidden="true" style="color:#E4791A";></i> Belongs to Physically Handicapped (PH)</label>
										<div class="col-lg-6" style="padding-left: 30px;">
											<label class="radio-inline">
												<input type="radio"  name="radioPhysicallY" id="radioPhysicallY" value="NO" <?php if($radioPhysicallY=="NO") { echo "checked"; } ?>  > NO
											</label>
											<label class="radio-inline">
												<input type="radio" name="radioPhysicallY" id="radioPhysicallY" value="YES" <?php if($radioPhysicallY=="YES") { echo "checked"; } ?>  > YES
											</label>
										</div>
									</div>
								</div>
							...
							<!--**************END OF GENDER AND PHYSICAL FITNESS*********-->
											...
											<div  class="row"  style="margin-top: 20px;">
												<div class="col-lg-6">
													<div class="form-group">
														...
														<div class="col-lg-7">
															<select class="form-control" name="cmbNationality" id="cmbNationality" value="IND" >
																<?php
								...
								<!-- 			<div  class="row"  style="margin-top: 20px;display:none;" id="forNationality">
											...
											<div  class="row" style="margin-top: 20px;">
												<div class="col-sm-6">
													<div class="form-group">
														<label for="" class="col-lg-5" style=""><i style="color:red;font-size:18px;">*</i> <i class="fa fa-map-marker" aria-hidden="true" style="color:#E4791A"></i> Candidate Belongs To Ex-Sevicemen Category ?</label>
														<div class="col-lg-7">
															<label class="radio-inline">
																<input type="radio"  name="radiobelong" id="radiobelong" value="NO" <?php if($radiobelong=="NO") { echo "checked"; } ?>  onclick="hide('belongsto');"> NO
															</label>
															<label class="radio-inline">
																<input type="radio" name="radiobelong" id="radiobelong" value="YES" <?php if($radiobelong=="YES") { echo "checked"; } ?>  onclick="show('belongsto');"> YES
															</label>
														</div>
													</div>
												</div>

							<!-- 					<div class="col-sm-6" id="belongsto" style="padding-top: 10px;" <?php if($radiobelong=="YES") { echo ""; } else { echo 'hidden'; }?> >

													
														<div class="form-group">
															<label for="" class="col-lg-5 " ><i style="color:red;font-size:18px;">*</i> North East States</label>
															<div class="col-lg-7">
																<select name="cmbNorthState" id="cmbNorthState" class="form-control" >
																	<option value='' <?php if($cmbNorthState=="") {?> selected="selected" <?php } ?>>Select State</option>
																	
																	<option value='Assam' <?php if($cmbNorthState=="Assam") {?> selected="selected" <?php } ?>>Assam</option>

																	<option value='Sikkim'  <?php if($cmbNorthState=="Sikkim") {?> selected="selected" <?php } ?>>Sikkim</option>

																	<option value='Arunachal Pradesh'  <?php if($cmbNorthState=="Arunachal Pradesh") {?> selected="selected" <?php } ?>>Arunachal Pradesh</option>
																	
																	<option value='Manipur'  <?php if($cmbNorthState=="Manipur") {?> selected="selected" <?php } ?>>Manipur</option>

																	<option value='Meghalaya'  <?php if($cmbNorthState=="Meghalaya") {?> selected="selected" <?php } ?>>Meghalaya</option>

																	<option value='Mizoram'  <?php if($cmbNorthState=="Mizoram") {?> selected="selected" <?php } ?>>Mizoram</option>

																	<option value='Tripura'  <?php if($cmbNorthState=="Tripura") {?> selected="selected" <?php } ?>>Tripura</option>

																	<option value='Nagaland'  <?php if($cmbNorthState=="Nagaland") {?> selected="selected" <?php } ?>>Nagaland</option>										
																</select>
															</div>
														</div>
						...
						<div class="col-lg-12" style="box-shadow: 0px 7px 20px -6px #090909; background-color: #F1F1F1;border: 1px solid rgb(255, 255, 255); border-radius: 5px; width: 100%;height: auto;padding: 21px;margin-top: 20px;">
							<h3 style="text-align: center;margin-top: -6px;color: #666;"> Parent/Guardian Details</h3>
											<div  class="row"  style="margin-top: 20px;">
												<div class="col-lg-6">
													<div class="form-group">
														...
														<div class="col-lg-7">
															<input type="text" class="form-control" id="txtFatherName" name="txtFatherName" placeholder="Enter Father's Name" maxlength="80"  onkeyup="changeCase(this)"  value="<?=strtoupper($txtFatherName)?>" >
														</div>
													</div>
												</div>
												...
												<div class="col-lg-6">
													<div class="form-group">
														<label for="" class="col-lg-5" style=""> <i class="fa fa-credit-card" aria-hidden="true" style="color:#E4791A"></i> Father's / Mother's Profession</label>
														<div class="col-lg-7">
															<input type="text" class="form-control test" id="FathersProfession" name="FathersProfession" placeholder="Enter The Profession" maxlength="80"  onkeyup="changeCase(this)" data-placement="top" data-toggle="tooltip" value="<?=$FathersProfession;?>" title="" >
														</div>
													</div>
												</div>						
											</div>
										    <div  class="row"  style="margin-top: 20px;">
											   <div class="col-lg-6">
													<div class="form-group">
														<label for="" class="col-lg-5" style=""><i style="color:red;font-size:18px;">*</i> <i class="fa fa-male" aria-hidden="true" style="color:#E4791A"></i> Family Annual Income</label>
														<div class="col-lg-7">
															<input type="text" class="form-control" id="FathersIncome" name="FathersIncome" onkeypress="return isNumberKey(event)" placeholder="Enter The Income"   value="<?=$FathersIncome;?>" maxlength="8" data-placement="top" data-toggle="tooltip" title="Your Father's Annual Income. Put 0(zero) if no Income. Ex:20000000 or 0" >
														</div>
													</div>
												</div>
												...
												<div class="col-lg-6">
													<div class="form-group">
														<label for="" class="col-lg-5" style=""> <i class="fa fa-male" aria-hidden="true" style="color:#E4791A"></i> Mother's Name</label>
														<div class="col-lg-7">
															<input type="text" class="form-control" id="txtMotherName" name="txtMotherName" placeholder="Enter Mother's Name" maxlength="80"  onkeyup="changeCase(this)"  value="<?=strtoupper($MothersName)?>" >
														</div>
													</div>
												</div>
											...
											<div  class="row"  style="margin-top: 20px;">
											 	<div class="col-lg-6">
													<div class="form-group">
														...
														<div class="col-lg-7">
															<input type="text" class="form-control test" id="MothersProfession" name="MothersProfession" placeholder="Enter Guardian Name" maxlength="80"  onkeyup="changeCase(this)" data-placement="top" data-toggle="tooltip" value="<?=$MothersProfession?>" title="" >
														</div>
													</div>
												</div>
										...
										<div class="col-lg-12" style="box-shadow: 0px 7px 20px -6px #090909; background-color: #F1F1F1;border: 1px solid rgb(255, 255, 255); border-radius: 5px; width: 100%;height: auto;padding: 21px;    margin-top: 35px;">
											...
											<!--<div class="row">
												<div class="col-lg-6">
													<div class="form-group">
														...
														<div class="col-lg-7">
															<input type="text" class="form-control" name="co_name" id="co_name" value="<?=$co_name?>"  onkeyup="changeCase(this)" maxlength="80"  >
														</div>
													</div>
												</div>
											</div>-->
											...
											<div class="row"  style="margin-top: 20px;">
												...
												<div class="col-lg-6">
													<div class="form-group">
														<label for="" class="col-lg-5" style="    padding-right: 35px;">&nbsp;&nbsp; Post</label>
														<div class="col-lg-7">
											...
											<div class="row"  style="margin-top: 20px;">
												...
												<div class="col-lg-6">
													<div class="form-group">
														<label for="" class="col-lg-5" >&nbsp;&nbsp; PIN</label>
														<div class="col-lg-7">
											 ...
											 <!-- <div class="row" style="margin-top: 20px;">
												...
												<div class="col-lg-6">
													<div class="form-group">
														...
														<div class="col-lg-7">
															<input type="text" class="form-control" name="phone_no" id="phone_no" onkeypress="return isNumberKey(event)" maxlength="10" value="<?=$mobile?>"  >
														</div>
													</div>
												</div>
											...
											<!--<div class="row">
												<div class="col-lg-6">
													<div class="form-group">
														<label for="" class="col-lg-5 " ><i style="color:red;font-size:18px;">*</i> C/O</label>
														<div class="col-lg-7">
															<input type="text" class="form-control" name="co_name1" id="co_name1" onkeyup="changeCase(this)" maxlength="80" value="<?=$co_name1?>" >
														</div>
													</div>
												</div>
											</div>-->
											...
											<!-- <div class="row" style="margin-top: 20px;">
												...
												<div class="col-lg-6">
													<div class="form-group">
														<label for="" class="col-lg-5 " ><i style="color:red;font-size:18px;">*</i> Phone No</label>
														<div class="col-lg-7">
															<input type="text" class="form-control" name="phone_no1" id="phone_no1" onkeypress="return isNumberKey(event)" maxlength="10" value="<?=$txtPermanentMobile?>"  >
														</div>
													</div>
												</div>
									...
									<!-- <div class="col-lg-12" style="box-shadow: 0px 7px 20px -6px #090909; background-color: #F1F1F1;border: 1px solid rgb(255, 255, 255); border-radius: 5px; width: 100%;height: auto;padding: 21px;    margin-top: 35px;">
									 	<div class="col-sm-12 form-group">
									        <div class="col-sm-6">
												<label for="" class="control-label" ><i style="color:red;font-size:18px;">*</i> Whether Employed : (Please tick in the appropriate box) <br>(If employed, no objection certificate from the employer has to be submitted)</label>
											</div>
											    
											<div class="col-sm-4">
												
												<label class="radio-inline">
													<input type="radio" name="employed" id="employed" value="NO" <?php if($is_employed=="NO") { echo "checked"; } ?>  onclick="hide('employer_id');"> NO
												</label>
												<label class="radio-inline">
													<input type="radio" name="employed" id="employed" value="YES" <?php if($is_employed=="YES") { echo "checked"; } ?>  onclick="show('employer_id');"> YES
												</label>

											</div>
										</div>

										<div class="col-sm-12" id="employer_id" style="background: #fff; padding-top: 10px;" <?php if($is_employed=="YES") { echo ""; } else { echo 'hidden'; }?> >
												
											
												<table class=" col-sm-12 table">
													<thead>
														<tr>
															<th style="width: 50%;">Name & Address Of Employer</th>
															<th>From</th>
															<th <?php if($employer_from!="") { echo ""; } else { echo 'hidden'; }?> id="emp_to">To</th>
														</tr>
													</thead>
													 
													<tbody>
														<tr>
															<td><div class="form-group"><input type="text" class="form-control " name="Employer_address" onkeyup="changeCase(this)" maxlength="99" value="<?=$employer_add?>" ></div></td>
															<td><div class="form-group"><input type="text" class="form-control " name="Employer_from" id="Employer_from" value="<?=$employer_from?>"  readonly></div></td>
															<td><div class="form-group"><input type="text" class="form-control " name="Employer_to" id="Employer_to" value="<?=$employer_to?>"  readonly></div></td>
														</tr>
 									...
 									<div class="col-lg-12" style="box-shadow: 0px 7px 20px -6px #090909; background-color: #F1F1F1;border: 1px solid rgb(255, 255, 255); border-radius: 5px; width: 100%;height: auto;padding: 21px;margin-top: 20px;">
											<div  class="row"  style="margin-top: 20px;">
												<div class="col-lg-12">
													<div class="form-group" >
														<label for="" class="col-lg-5"  ><i style="color:red;font-size:18px;">*</i> <i class="fa fa-graduation-cap" aria-hidden="true" style="color:#E4791A;"></i> 10th </label>
														<div class="col-lg-7">
															<label class="radio-inline">
																<input type="radio" name="radioMarkSheet" id="radioYesMarks" value="Yes" <?php if($radioMarkSheet=="Yes") { echo "checked"; } ?> > Passed
															</label>
															<label class="radio-inline">
																<input type="radio" name="radioMarkSheet" id="radioNoMarks" value="No" <?php if($radioMarkSheet=="No") { echo "checked"; } ?> > Appeared
															</label>
											...
											<div id="radioNoGradCert"  class="row"  style="margin-top: 20px;">
												<div class="col-lg-12">
													<div class="form-group" >
														<label for="" class="col-lg-5"  ><i style="color:red;font-size:18px;">*</i> <i class="fa fa-certificate" aria-hidden="true" style="color:#E4791A;"></i> Whether 10th Certificate Arrived?</label>
														<div class="col-lg-7">
															<label class="radio-inline">
																<input type="radio" name="radioGradCert" id="radioYesGradCert" value="Yes" <?php if($radioGradCert=="Yes") { echo "checked"; } ?> > Yes
															</label>
															<label class="radio-inline">
																<input type="radio" name="radioGradCert" id="radioNoGradCert" value="No" <?php if($radioGradCert=="No") { echo "checked"; } ?> > No
															</label>
											...
											<div id="radioGradMarkSheet"  class="row"  style="margin-top: 20px;">
												<div class="col-lg-12">
													<div class="form-group" >
														<label for="" class="col-lg-5"  ><i style="color:red;font-size:18px;">*</i> <i class="fa fa-certificate" aria-hidden="true" style="color:#E4791A;"></i> Whether 10th Mark Sheet Arrived?</label>
														<div class="col-lg-7">
															<label class="radio-inline">
																<input type="radio" name="radioGradMarkSheet" id="radioYesGradMarkSheet" value="Yes" <?php if($radioGradMarkSheet=="Yes") { echo "checked"; } ?> > Yes
															</label>
															<label class="radio-inline">
																<input type="radio" name="radioGradMarkSheet" id="radioNoGradMarkSheet" value="No" <?php if($radioGradMarkSheet=="No") { echo "checked"; } ?> > No
															</label>
												...
												<div class="col-sm-12">
													<div class="table-responsive">
														<table  class="table table-bordered table-striped">
															<tr>
																<th width="40" style="text-align:center;">Name of the Examination</th>
																<th width="10" style="text-align:center;">Year Of Passing</th>
																<th width="20" style="text-align:center;">Board/University</th>
																<th width="10" style="text-align:center;">Marks Secured/CGPA</th>
																<th width="10" style="text-align:center;">Maximum Marks/CGPA</th>
																<th width="10" style="text-align:center;">% of Marks</th>
															</tr>
															<?php
																$sl_no =1;
																...
																foreach($allQualifications as $row)
																{
																	...
																	$graduation_quali=${'txtQualification3'};
																?>
																<tr>
																	<?php if($row['qualification_name'] == 'Graduation'){ ?>
																	<td ><div class="form-group"><select class="form-control input-sm" name="txtQualification<?=$sl_no?>" id="txtQualification<?=$sl_no?>">
																		
																	</select></div></td>
																	<?php } else { ?>
																		<td style="width: 20%"><input type="text" class="form-control input-sm" name="txtQualification<?=$sl_no?>" id="txtQualification<?=$sl_no?>" value="<?=$row['qualification_name']?>"  readonly="readonly"/></td>
																	<?php } ?>
																	
																	<td style="width: 15%"><div class="form-group"><input type="text" class="form-control input-sm" id="txtYear<?=$sl_no?>" name="txtYear<?=$sl_no?>" onkeypress="return isNumberKey(event)" maxlength="4"   value="<?php echo ${'txtYear'.$sl_no} == 'NULL'?'':${'txtYear'.$sl_no}; ?>"  /></div></td>
																	<td style="width: 20%"><div class="form-group"><input type="text" class="form-control input-sm" id="txtBoard<?=$sl_no?>" name="txtBoard<?=$sl_no?>" value="<?=${'txtBoard'.$sl_no}?>"  onkeyup="changeCase(this)" maxlength="50"/></div></td>
																	
																	
																	<td style="width: 15%"><div class="form-group"><input type="text" class="form-control input-sm" id="txtMS<?=$sl_no?>" name="txtMS<?=$sl_no?>" value="<?php echo ${'txtMS'.$sl_no} == 'NULL'?'':${'txtMS'.$sl_no}; ?>" onkeypress="return isNumberKey(event)" onblur="calculatePercentage(<?=$sl_no?>)"  /></div></td>
																	<td style="width: 15%"><div class="form-group"><input type="text" class="form-control input-sm" id="txtFM<?=$sl_no?>" name="txtFM<?=$sl_no?>" value="<?php echo ${'txtFM'.$sl_no} == 'NULL'?'':${'txtFM'.$sl_no}; ?>" onkeypress="return isNumberKey(event)" onblur="calculatePercentage(<?=$sl_no?>)"  /></div></td>
																	<td style="width: 10%"><div class="form-group"><input type="text" class="form-control input-sm" readonly id="txtPercent<?=$sl_no?>" name="txtPercent<?=$sl_no?>" value="<?php echo ${'txtPercent'.$sl_no} == 'NULL'?'':${'txtPercent'.$sl_no}; ?>" /></div></td>
																</tr>
																	<?php
																	$sl_no++;
																	}
																...
																<!--<tr>
																	...
																	<td><div class="form-group"><input type="text" class="form-control input-sm" id="txtYear5" name="txtYear5" onkeypress="return isNumberKey(event)"   value="<?php echo $txtYear5 == 'NULL'?'':$txtYear5; ?>"  /></div></td>
																	<td><div class="form-group"><input type="text" class="form-control input-sm" id="txtBoard5" name="txtBoard5" value="<?=$txtBoard5 ?>"  onkeydown="changeCase(this)" onkeyup="changeCase(this)" onblur="changeCase(this)" onclick="changeCase(this)"/></div></td>
																	
																			
																<td><div class="form-group"><input type="text" class="form-control input-sm" id="txtMS5" name="txtMS5" value="<?php echo $txtMS5 == 'NULL'?'':$txtMS5; ?>" onkeypress="return isNumberKey(event)" onblur="calculatePercentage(5)" /></div></td>
																<td><div class="form-group"><input type="text" class="form-control input-sm" id="txtFM5" name="txtFM5" value="<?php echo $txtFM5 == 'NULL'?'':$txtFM5; ?>" onkeypress="return isNumberKey(event)" onblur="calculatePercentage(5)" /></div></td>
																<td><div class="form-group"><input type="text" readonly class="form-control input-sm" id="txtPercent5" name="txtPercent5" value="<?php echo $txtPercent5 == 'NULL'?'':$txtPercent5 ;?>" onfocus="calculatePercentage(5)" /></div></td>
										...
										<div class="row" >
											...
											<!--<div class="col-md-12">
												<div class="form-group col-md-9 ">
													...
													<div class="col-lg-7">
														<input type="text" class="form-control " name="txtfinalpercentage" maxlength="5" max="101" value="<?=$txtfinalpercentage?>" id="txtfinalpercentage"   >
													</div>
												</div>
											</div>-->
										</div>
										...
										<div class="row" >
											...
											<!--<div class="col-md-12">
												<div class="form-group col-md-9 ">
													...
													<div class="col-lg-7">
														<input type="text" class="form-control datepicker" name="completion_date" value="<?=$completion_date?>" id="completion_date"   readonly>
													</div>
												</div>
											</div>-->
										</div>
                     ...
                     <!-- <div class="row" style="margin-top: 20px;">
										<div class="col-sm-12">
											...
											<div class="col-sm-3">
												...
												<input type="text" class="form-control" name="amount_paid" id="amount_paid" value="<?=$amount_paid?>"  >
											</div>

											<div class="col-sm-3">
												<label>Bank Draft No..</label>
												<input type="Number" class="form-control" name="draft_no" id="draft_no" value="<?=$draft_no?>"  >
											</div>

											<div class="col-sm-3">
												<label>Dated</label>
												<input type="date" class="form-control" name="payment_date" id="payment_date" value="<?=$payment_date?>"  >
											</div>
 ...
 -->
								...
								<div class="col-lg-12" style="box-shadow: 0px 7px 20px -6px #090909; background-color: #F1F1F1;border: 1px solid rgb(255, 255, 255); border-radius: 5px; width: 100%;height: auto;padding: 21px;    margin-top: 35px;">
								 	<div class="col-sm-12 form-group">
								        <div class="col-sm-5">
											<label for="" class="control-label" ><i style="color:red;font-size:18px;">*</i>&nbsp;&nbsp; How Would You Pay The Application Fee?</label>
										</div>
										    
										<div class="col-sm-7">
											
											<label class="radio-inline">
												<input type="radio" name="mode" id="modeOnline" value="Online" <?php if($mode=="Online") { echo "checked"; } ?>  > Online
											</label>
											<label class="radio-inline">
									...
									<div class="row">
										<div class="form-group">
											<div class="col-sm-12" align="justify">
												...
												found guilty of any misconduct I shall be liable for punishment as deemed fit by the Institute authority.
											</div>
										</div>
									</div>
						...
						<script src="<?php echo base_url(); ?>public/assets/js/template014.js?v=5"></script>
...
/*.login-box-body, .register-box-body {
	...
	.box button{
	  ...
	  <script>
	  selecting_value = "<?=$graduation_quali?>";
