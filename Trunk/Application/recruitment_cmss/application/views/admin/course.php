...
<div class="content-wrapper">
	<div class="row">
        ...
        <section class="content-header">
	      	<h1>
	        	Category Wise Age Relaxation Setup
	      	</h1>
	    </section>
    	<!-- /.col-lg-12 -->
	</div>
					...
					<div class="col-sm-12">
						<table class="table table-striped table-bordered" id="tblCounsellingPeriod" width="100%">
							<thead>
								<tr>
									<th >Sl No</th>
									<th >Program Code</th><!-- id will be hide --> 
									<th >Program Name</th>
									<th >Course Name</th>
									<th >Course code</th>
									<th >Eligible Start Date</th>
									<th >Eligible End Date</th>
									<th >Action</th>
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<form class="form-horizontal" Resource="form"  id="frmCounsellingPeriod" name="frmCounsellingPeriod">
										...
										<div class="form-group">
											<label class="col-sm-4 control-label"><i style="color:red;font-size:18px;">*</i> Course Name</label>
											<div class="col-sm-8">
												<input type="text"  class="form-control" id="txtCourseName" name="txtCourseName"  title="Course Name">
											</div>
										</div>
										<div class="form-group"> 
											<label class="col-sm-4 control-label"><i style="color:red;font-size:18px;">*</i> Course Code</label>
											<div class="col-sm-8">
												<input type="text"  class="form-control" id="txtCoursecode" name="txtCoursecode"  title="Course code">
											</div>
										</div>
										<div class="form-group">
											<label for="" class="col-sm-4 control-label"><i style="color:red;font-size:18px;">*</i> Eligible Start Date</label> 
											<div class="col-sm-8">
												<input type="text"  class="form-control tooltips" id="txtAgeStartdate" name="txtAgeStartdate"  title="Eligible Start Date" readonly="">
											</div>
										</div>
										<div class="form-group">
											<label for="" class="col-sm-4 control-label"><i style="color:red;font-size:18px;">*</i> Eligible End Date</label>
											<div class="col-sm-8">
...
<script type="text/javascript" language="javascript" src="<?php echo base_url(); ?>public/assets/js/admin/course.js"></script>
