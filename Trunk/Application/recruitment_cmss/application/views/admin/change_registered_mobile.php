...
<div class="content-wrapper">
	<div class="row">
		<!--<div class="col-lg-12 page-header">
			<h3>Change Registered Mobile</h3>
		</div>-->
		...
		<section class="content">
			<div class="row">
							...
							<div style="border-radius:0px;border: 0px inset;padding-left:20px;padding-right:20px;padding-top:0px;">
								<form class="form-horizontal" method="post" role="form" id="frmChangeProgram" name="frmChangeProgram">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" id="txtRegUserId" name="txtRegUserId" class="form-control"/>
										</div>
									</div>
									</div><!-- end row -->
									<div class="row">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" name="txtChangeRegUserId" id="txtChangeRegUserId" class="form-control" maxlength="10" onkeypress="return isNumber(event);"/>
										</div>
									</div>
									</div>
									<div class="row">
				...
				<script type="text/javascript" language="javascript" src="<?php echo base_url(); ?>public/assets/js/admin/change_registered_mobile.js"></script>
