			...
			<!--<div class="panel with-nav-tabs panel-primary">
				...
				<div class="nav-tabs-custom box box-default">
					<ul class="nav nav-tabs" role="tablist">
						...
						<li><a href="#qualificationdegreemap" data-toggle='tab'><b>Qualification Degree Mapping</b></a></li>
						<li><a href="#qualificationdegreecoursemap" data-toggle='tab'><b>Degree Course Mapping</b></a></li>
						<!--<li><a href="#qualification" data-toggle='tab'><b>Qualification</b></a></li>-->
						<li><a href="#examcenter" data-toggle='tab'><b>Exam Center</b></a></li>
						<li><a href="#declaration" data-toggle='tab'><b>Declaration</b></a></li>
				...
				<div class="panel-body">-->
       				<div class="tab-content">
							...
							<div class="col-lg-12">
								<table class="table table-striped table-bordered" id="tblreligionMaster" width="100%">
									<thead>
										<tr>
											<th class="text-left">#</th>
											<th class="text-left">Religion Code</th>
											<th class="text-left">Religion Name</th>
											<th class="text-left">Action</th> 
										</tr>
									</thead>
									<tbody>
						...
						<div class="modal fade" id="ReligionAddModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static">
							<div class="modal-dialog"style="width: 50%;">
								<div class="modal-content">
									...
									<div class="modal-body">
										<form class="form-horizontal" role="form"  id="frmReligion" name="frmReligion">
										<input type="hidden" id="hidReligioneditid" name="hidReligioneditid">
											<div id="errorlog_country_add" style="display: none; color: red; font-size: 12px;"></div>
											<div class="form-group">
												...
												<div class="col-sm-9">
													...
													<input type="text" class="form-control tooltips" id="txtReligionCode" maxlength="8" name="txtReligionCode" title="Religion Code" placeholder="">
												</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" class="form-control tooltips" id="txtReligionName" maxlength="50" name="txtReligionName" placeholder="" title="Religion Name">
												</div>
												<p class="modalExbottom" style="margin-left: 180px;">Ex: Hindu</p>
											</div>
											<div class="modal-footer">
						...
						<!---Religion Tab end -->
						<!-----Qualification Degree Mapping-->
						<div class="chart tab-pane" id="qualificationdegreemap">
							<!--<div class="col-lg-12">
								<h1 class="page-header">Define District:</h1>
							</div>-->
							<div class="col-lg-12">
								<table class="table table-striped table-bordered" id="tblqualdegreemapMaster" width="100%">
									<thead>
										<tr>
											<th class="text-left">#</th>
											<th hidden="">Program group</th>
						...
						<div class="modal fade" id="DegreeAddModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static">
							<div class="modal-dialog"style="width: 50%;">
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal" aria-hidden="true">
									...
									<div class="modal-body">
										<form class="form-horizontal" role="form"  id="frmDegree" name="frmDegree">
										<input type="hidden" id="hidDegreeditid" name="hidDegreeditid">
										<input type="hidden" class="form-control tooltips" id="txtProgram" name="txtProgram" >
											<div id="errorlog_country_add" style="display: none; color: red; font-size: 12px;"></div>
											<div class="col-lg-12 page-header">
											
											</div>
											<div class="form-group">
												<label for="" class="col-sm-3 control-label" id ="cmbProgramGroupl" >Recruitment Drive:</label>
												<div class="col-sm-9">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<select class="form-control cmbSelectProgram"  name="cmbSelectProgram" title="Select Post" id="cmbSelectProgram" >
													</select>
												</div>
											</div>
											<div class="form-group">
												<label for="inputname" class="col-sm-3 control-label"><i style="color:red;font-size:15px;">*</i>Qualification</label>
												<div class="col-sm-9">
													<input type="hidden" id="hidOperDegree" name="hidOperDegree">
													
													<select class="form-control" id="cmbQualification" name="cmbQualification">
														<option value="">Select</option>
														<option value="SRSEC">CLASS XII/+2</option>
											...
											<div class="form-group">
												<label for="" class="col-sm-3 control-label"><i style="color:red;font-size:15px;">*</i> Degree Name</label>
												<div class="col-sm-9">
													<input type="text" class="form-control tooltips" id="txtDegreeName" maxlength="50" name="txtDegreeName" placeholder="" title="Religion Name" autocomplete="off">
												</div>
											</div>
											<div class="modal-footer">
												<span id="spanProcessingCountryAdd" style="display: none">Processing... <img src="<?=base_url()?>public/assets/images/bx_loader.gif" /></span>
						...
						<!------end degree mapping-->
						<!-----Declaration Mapping-->
						<div class="chart tab-pane" id="declaration">
							<!--<div class="col-lg-12">
								<h1 class="page-header">Define District:</h1>
							</div>-->
							<div class="col-lg-12">
								<table class="table table-striped table-bordered" id="tbldeclarationMaster" width="100%">
									<thead>
										<tr>
											<th class="text-left">#</th>
											<th hidden="">Program group</th>
											<th class="text-left">Program name</th>
											<th hidden="">Program Code</th>
											<th class="text-left">Declaration</th>
											<th hidden="">Id</th>
											<th class="text-left">Action</th> 
										</tr>
									</thead>
						...
						<div class="modal fade" id="DeclarationModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static">
							<div class="modal-dialog"style="width: 50%;">
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal" aria-hidden="true">
										...
										<h4 class="modal-title" id="myModalLabel">Add Declaration</h4>
									</div>
									<div class="modal-body">
										<form class="form-horizontal" role="form"  id="frmDeclaration" name="frmDeclaration">
										<input type="hidden" id="hidDeclarationid" name="hidDeclarationid">
										<input type="hidden" id="hidOperDeclaration" name="hidOperDeclaration">
											<div id="errorlog_country_add" style="display: none; color: red; font-size: 12px;"></div>
											<div class="col-lg-12 page-header">
											
											</div>
											<div class="form-group">
												<label for="" class="col-sm-3 control-label" id ="declar" >Recruitment Drive:</label>
												<div class="col-sm-9">
													<select class="form-control" name="cmbProgramGroupdeclar" id="cmbProgramGroupdeclar">
													</select>
												</div>
											</div>
											<div class="form-group">
												<label for="" class="col-sm-3 control-label">Post:</label>  
												<div class="col-sm-9">
													<select class="form-control cmbSelectProgramdeclar"  name="cmbSelectProgramdeclar" title="Select Post" id="cmbSelectProgramdeclar" >
													</select>
												</div>
											</div>
											
											<div class="form-group">
												<label for="" class="col-sm-3 control-label"><i style="color:red;font-size:15px;">*</i> Declaration</label>
												<div class="col-sm-9">
													<textarea class="form-control tooltips" id="txtDeclaration"  name="txtDeclaration" placeholder="" title="Declaration" autocomplete="off"> </textarea>
												</div>
											</div>
											<div class="modal-footer">
												<span id="spanProcessingCountryAdd" style="display: none">Processing... <img src="<?=base_url()?>public/assets/images/bx_loader.gif" /></span>
						...
						<!------end declaration mapping-->
						<!----Qualification degree course map-->
						<div class="chart tab-pane" id="qualificationdegreecoursemap">
							<!--<div class="col-lg-12">
								<h1 class="page-header">Define District:</h1>
							</div>-->
							<div class="col-lg-12">
								<table class="table table-striped table-bordered" id="tblqualdegreecoursemapMaster" width="100%">
									<thead>
										<tr>
											<th class="text-left">#</th>
						...
						<div class="modal fade" id="CourseAddModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static">
							<div class="modal-dialog"style="width: 50%;">
								<div class="modal-content">
									...
									<div class="modal-body">
										<form class="form-horizontal" role="form"  id="frmCourse" name="frmCourse">
										<input type="hidden" id="hidCourseeditid" name="hidCourseeditid">
											<div id="errorlog_country_add" style="display: none; color: red; font-size: 12px;"></div>
											<div class="form-group">
												<label for="" class="col-sm-3 control-label" id ="cmbProgramGroup2" ><i style="color:red;font-size:15px;">*</i>Recruitment Drive:</label>
												<div class="col-sm-9">
													<select class="form-control" name="cmbProgramGroupQual2" id="cmbProgramGroupQual2" onchange="change_cmbProgramGroupQual2();">
													</select>
												</div>
											</div>
											<div class="form-group">
												<label for="" class="col-sm-3 control-label"><i style="color:red;font-size:15px;">*</i>Post:</label>  
												<div class="col-sm-9">
													<select class="form-control cmbSelectProgramCourse"  name="cmbSelectProgram2" title="Select Post" id="cmbSelectProgram2" >
													</select>
												</div>
											</div>
											<div class="form-group">
												<label for="inputname" class="col-sm-3 control-label"><i style="color:red;font-size:15px;">*</i> Qualification Name</label>
												<div class="col-sm-9">
													<input type="hidden" id="hidOperCourse" name="hidOperCourse">
													<!--<input type="text" class="form-control tooltips" id="txtQualificationCode" maxlength="8" name="txtQualificationCode" title="Qualification Code" placeholder="">-->
													<select class="form-control" id="cmbQualificationcourse" name="cmbQualificationcourse" onchange="change_cmbQualificationcourse()">
														<option value="">Select</option>
														<option value="SRSEC">Intermediate</option>
														<option value="GRADUTION">Graduation</option>
														<option value="PG">Post Graduation</option>
													</select>
												</div>
											...
											<div class="form-group">
												<label for="" class="col-sm-3 control-label"><i style="color:red;font-size:15px;">*</i> Degree Name</label>
												<div class="col-sm-9">
												<select class="form-control" name="cmbdegree" id="cmbdegree">
													
												</select>
												</div>
											</div>
											<div class="form-group">
												<label for="" class="col-sm-3 control-label"><i style="color:red;font-size:15px;">*</i> Course Name</label>
												<div class="col-sm-9">
													<input type="text" class="form-control tooltips" id="txtcourse"  name="txtcourse" title="Course Name" placeholder="">
												</div>
											</div>
											<div class="modal-footer">
												<span id="spanProcessingCountryAdd" style="display: none">Processing... <img src="<?=base_url()?>public/assets/images/bx_loader.gif" /></span>
						...
						<!---end of Qualification degree course map-->
						<!--District Tab -->
...
<script type="text/javascript" src="<?=base_url()?>public/assets/js/admin/generic_setup2.js"></script>