				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="myModalLabel">CORRIGENDUM</h4>
						</div>
							...
							<form class="form-horizontal" role="form"  id="frmAdditionalData" name="frmAdditionalData">
								...
								<div class="row col-sm-12 col-xs-12 ">
										<div class="col-sm-6 col-xs-6">
											...
											<div class="form-group">
												<label for="" class="col-sm-4 control-label"><i style="color:red;font-size:15px;">*</i> Document Type :</label>
												<div class="col-sm-8">
											...
											<div class="form-group">
												<label for="" class="col-sm-4 control-label"><i style="color:red;font-size:15px;">*</i> Document Name:</label>
												<div class="col-sm-8">
												<input type="text"  class="form-control tooltips" id="fileResultname" name="fileResultname"  title="Document Name" placeholder="Document Name">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-8 input-file" >
													<input type="file" class="form-control" id="fileResultpdf " name="fileResultpdf" />
...
<script type="text/javascript" language="javascript" src="<?php echo base_url(); ?>public/assets/js/admin/important_notice.js?v=3"></script>			