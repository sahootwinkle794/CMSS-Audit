								...
								<div class="row col-sm-12 col-xs-12 ">
										<div class="col-sm-12 col-xs-12">
											...
											<div class="form-group">
											 	...
											 	<label for="" class="col-sm-4 control-label"><i style="color:red;font-size:15px;">*</i> Information:</label>
												<div class="col-sm-8">
...
<script type="text/javascript" language="javascript" src="<?php echo base_url(); ?>public/assets/js/admin/general_information.js?v=3"></script>		
