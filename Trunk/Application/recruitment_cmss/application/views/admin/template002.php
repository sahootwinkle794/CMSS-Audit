		...
		<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10 col-xl-10">	
			...
			{ 
				...
				{ 
					...
					<button type="button" onclick="window.location.href = '<?=base_url()?>Admin_apply/<?php echo $file_name; ?>/ins/<?=$ins?>/edit/<?=$edit_status?>';"  class="col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 btn btn-primary btn-rounded btn-lg" style="background-color: #BBFEAE;border: 1px solid #BBFEAE; border-radius: 5px;color: black">
			...
			{ 
				?>
					<button type="button" onclick="window.location.href = '<?=base_url()?>Admin_apply/<?php echo $file_name; ?>/ins/<?=$ins?>/edit/<?=$edit_status?>';"  class="col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 btn btn-primary btn-rounded btn-lg" style="background-color: #E9CDCD;border: 1px solid #E9CDCD; border-radius: 5px;color: black">
						<div class="hidden-xs hidden-sm col-md-12 col-lg-12 col-xl-12">
							Profile Details <span class="badge"> &raquo;</span>
						</div>
						<div class="col-xs-12 col-sm-12 hidden-md hidden-lg hidden-xl"  title="Profile Details" data-placement="top" data-toggle="tooltip">
...
<script src="<?php echo base_url(); ?>public/assets/js/admin/template002.js?v=<?php rand()?>"></script>
