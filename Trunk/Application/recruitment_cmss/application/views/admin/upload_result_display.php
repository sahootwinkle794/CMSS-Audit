    ...
    <table class="table table-hover tablesorter">
        <thead>
            <tr>
				...
				<th class="text-left">Bar Code</th>
            ...
            if (isset($employeeInfo) && !empty($employeeInfo)) {
                ...
                foreach ($employeeInfo as $key => $element) {
                    ...
                    <tr>
                        ...
                        <td><?php echo $element['applicant_id']; ?></td>                       
                        <td><?php echo $element['barcode']; ?></td>
                        <td><?php echo $element['total_mark']; ?></td>
                    </tr>
                    <?php
                    $sl_no++;
                }?>
...
<script type="text/javascript">
	   opener.load_result_table();  
	   /*window.close();*///CLOOSE ALREADY OPEN POPUP WINDOW
	</script>
<!--<script type="text/javascript">
   opener.load_table(program,program_group);   
   /*window.close();*///CLOOSE ALREADY OPEN POPUP WINDOW
</script>-->
