		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" id="menuForm" name="menuForm">
					...
					<input type="hidden" id="hidOperType" name="hidOperType" value="add_information_type_menu"/>
					<div class="form-group">
						<label for="txtMenu" class="col-sm-3 control-label"><i style="color:red;font-size:15px;">*</i>Information Name</label>
						<div class="col-sm-9">
...
<script type="text/javascript" language="javascript" src="<?php echo base_url(); ?>public/assets/js/admin/manage_information_type.js"></script>   