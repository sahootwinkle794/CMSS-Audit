								...
								<div class="row col-sm-12 col-xs-12 ">
									...
									<div class="col-sm-6 col-xs-6">	
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<select class="form-control" id="cmbProgramFilter" name="cmbProgramFilter">
										...
										<div class="form-group">
											<label for="" class="col-sm-4 control-label"><i style="color:red;font-size:15px;">*</i>From</label>
											<div class="col-sm-8">
												<input type="text"  class="form-control tooltips" readonly="" id="txtAppStartdate" name="txtAppStartdate"  title="Apply Start Date" placeholder="Post Start Date">
											</div>
										</div>
										<div class="form-group">	
											<label for="" class="col-sm-4 control-label"><i style="color:red;font-size:15px;">*</i>To</label>
											<div class="col-sm-8">
												<input type="text"  class="form-control tooltips" readonly="" id="txtAppEnddate" name="txtAppEnddate"  title="Apply End Date" placeholder="Post End Date">
											</div>
										</div>
...
<script type="text/javascript" language="javascript" src="<?php echo base_url(); ?>public/assets/js/admin/post_date_setup.js?v=3"></script>			