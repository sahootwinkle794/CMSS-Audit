						...
						<div style="border-radius:0px;border: 0px inset;padding-left:20px;padding-right:20px;padding-top:0px;">
							...
							<!--<form class="form-horizontal" method="post" role="form" id="frmactionmaster" name="frmactionmaster">
							    ...
							    <div class="form-group"
									...
									<table class="table table-striped table-bordered " id="tblgeneralinformation">
										<thead>
											<tr>
												<th >Sl. No.</th>
												<th  hidden="">Id</th>
	...
	<div class="modal-dialog" style="width: 50%;">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" id="generalinfoForm" name="generalinfoForm">
					<div id="errorlog" style="display: none; color: red; font-size: 12px;"></div>
					<input type="hidden" id="hidid" name="hidid" value=""/>
					<input type="hidden" id="hidOperType" name="hidOperType" value="Add_generalinfo_setup"/>
...
<script type="text/javascript" language="javascript" src="<?php echo base_url(); ?>public/assets/js/admin/program_general_info.js"></script>     