			...
			<div class="content-wrapper">
				<div class="row">
					<!--<div class="col-lg-12 page-header">
						<h3>Admit card - Review & Publish</h3>
					</div>-->
					<section class="content-header">
				      	<h1>
				        	Admit card - Review & Publish
				      	</h1>
				    </section>
					<!-- Main content -->
			...
			<script type="text/javascript" language="javascript" src="<?php echo base_url(); ?>public/assets/js/admin/admitcard_review_publish.js"></script>
