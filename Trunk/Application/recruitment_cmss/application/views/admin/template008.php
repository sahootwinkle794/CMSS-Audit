							...
							<!-- <div class="row">
								<div class="col-lg-12">
									<div class="form-group">
										...
										<div class="col-sm-8" ">
											<input type="text" class="form-control"  id="master_name" name="master_name" value="<?=$master_name?>" />
										</div>
									</div>
								</div>
							</div> -->
									...
									<!--<div class="form-group">-->
										...
										<div class="col-sm-8">
											<div class="col-sm-4 form-group">
												...
												<select class="form-control" name="center_name1" id="center_name1COMMON"   >
											...
											<div class="col-sm-4 form-group">
												...
												<select class="form-control" name="center_name2" id="center_name2COMMON"   >
													<option value="">Select Preference</option>									 
												</select>
								...
								<div class="col-lg-8">
									<div class="form-group" >
										...
										<div class="col-lg-6" style="padding-left: 30px;">
											<label class="radio-inline">
												<input type="radio"  name="radioPhysicallY" id="radioPhysicallY" value="NO" <?php if($radioPhysicallY=="NO") { echo "checked"; } ?>   onclick="hide('divphtype');"> NO
											</label>
											<label class="radio-inline">
												<input type="radio" name="radioPhysicallY" id="radioPhysicallY" value="YES" <?php if($radioPhysicallY=="YES") { echo "checked"; } ?>   onclick="show('divphtype');"> YES
											</label>
										</div>
									</div>
								</div>
								<!--<div class="col-lg-4" id="divphtype" <?php if($radioPhysicallY=="YES") { echo ""; } else { echo 'hidden'; }?> >
									<div class="form-group" >
										<div class="col-lg-12" style="padding-left: 0px;">
											<input type="text" class="form-control" id="txtphtype" name="txtphtype" maxlength="30" onkeyup="changeCase(this)" placeholder="Specify PH Type" value="<?=$txtphtype?>" >
										</div>
									</div>
											...
											<div  class="row" style="margin-top: 20px;">
												<div class="col-sm-6">
													<div class="form-group">
														...
														<div class="col-lg-7">
															<label class="radio-inline">
																<input type="radio"  name="radiobelong" id="radiobelong" value="NO" <?php if($radiobelong=="NO") { echo "checked"; } ?>  > NO
															</label>
															<label class="radio-inline">
																<input type="radio" name="radiobelong" id="radiobelong" value="YES" <?php if($radiobelong=="YES") { echo "checked"; } ?>  > YES
															</label>
														</div>
													</div>
												</div>
							...
							<h3 style="text-align: center;margin-top: -6px;color: #666;"> Parent/Guardian Details</h3>
										...
										<!--<div class="col-lg-12" style="box-shadow: 0px 7px 20px -6px #090909; background-color: #F1F1F1;border: 1px solid rgb(255, 255, 255); border-radius: 5px; width: 100%;height: auto;padding: 21px;margin-top: 20px;">
											...
											<!--<div  class="row"  style="margin-top: 20px;">												
													...
													<div class="form-group">
														...
														<div class="col-lg-7">
															<input type="text" class="form-control" id="MothersIncome" name="MothersIncome" onkeyup="changeCase(this)"  value="<?=strtoupper($MothersIncome)?>"  >
														</div>
													</div>
												</div>
												...
												<div class="col-lg-6">
													<div class="form-group">
														...
														<div class="col-lg-7">
															<input type="text" class="form-control test" id="txtUid" name="txtUidM" placeholder="Enter Aadhaar No" maxlength="12" onkeypress="return isNumberKey(event)"   value="<?=$MothersAdhar?>" data-placement="top" data-toggle="tooltip" title="Aadhaar No must be a digit. Ex:123456789012" >
														</div>
													</div>
												</div>
											</div>
									...
									<div class="col-lg-12" style="box-shadow: 0px 7px 20px -6px #090909; background-color: #F1F1F1;border: 1px solid rgb(255, 255, 255); border-radius: 5px; width: 100%;height: auto;padding: 21px;    margin-top: 35px;">
									 	<div class="col-sm-12 form-group">
									        <div class="col-sm-6">
												<label for="" class="control-label" >Whether Employed : (Please tick in the appropriate box) <br>(If Employed, No Objection Certificate From The Employer Has To Be Submitted)</label>
											</div>
 										...
 										<div class="col-lg-12" style="box-shadow: 0px 7px 20px -6px #090909; background-color: #F1F1F1;border: 1px solid rgb(255, 255, 255); border-radius: 5px; width: 100%;height: auto;padding: 21px;margin-top: 20px;">
											<div  class="row"  style="margin-top: 20px;">
												<div class="col-lg-12">
													<div class="form-group" >
														<label for="" class="col-lg-5"  ><i style="color:red;font-size:18px;">*</i> <i class="fa fa-graduation-cap" aria-hidden="true" style="color:#E4791A;"></i><?php if($course_code == 'DPMD'){echo "Diploma"; } else {echo "Graduation"; } ?> </label>
														<div class="col-lg-7">
															<label class="radio-inline">
											...
											<div id="radioNoGradCert"  class="row"  style="margin-top: 20px;">
												<div class="col-lg-12">
													<div class="form-group" >
														<label for="" class="col-lg-5"  ><i style="color:red;font-size:18px;">*</i> <i class="fa fa-certificate" aria-hidden="true" style="color:#E4791A;"></i> Whether <?php if($course_code == 'DPMD'){echo "Diploma"; } else {echo "Graduation"; } ?> Certificate Arrived?</label>
														<div class="col-lg-7">
															<label class="radio-inline">
											...
											<div  id="radioGradMarkSheet" class="row"  style="margin-top: 20px;">
												<div class="col-lg-12">
													<div class="form-group" >
														<label for="" class="col-lg-5"  ><i style="color:red;font-size:18px;">*</i> <i class="fa fa-certificate" aria-hidden="true" style="color:#E4791A;"></i> Whether <?php if($course_code == 'DPMD'){echo "Diploma"; } else {echo "Graduation"; } ?> Mark Sheet Arrived?</label>
														<div class="col-lg-7">
															<label class="radio-inline">
													...
													<div class="table-responsive">
														<table  class="table table-bordered table-striped">
															<tr>
																...
																<th style="text-align:center;">Marks Secured / CGPA</th>
																<th style="text-align:center;">Maximum Marks / CGPA</th>
															...
															<?php
																...
																<tr id="<?php echo $row['qualification_code']; ?>">
																	...
																	<td><div class="form-group"><input type="text" class="form-control input-sm" id="txtBoard<?=$sl_no?>" name="txtBoard<?=$sl_no?>" value="<?=${'txtBoard'.$sl_no}?>"  onkeyup="changeCase(this)" maxlength="50"/></div></td>
