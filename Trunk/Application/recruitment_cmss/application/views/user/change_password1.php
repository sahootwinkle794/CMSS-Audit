		...
		<div class="well" style="margin-top: 150px;padding: 40px;">
			<?php echo form_open(null, array('class'=>'formchangepassword', 'id'=>'formchangepassword' ,'enctype'=>"multipart/form-data")); ?>
				<div class="form-group">
					<label for="inputname" class="col-lg-5 control-label">Old Password</label>
					<div class="col-lg-7">
						<input type="password" class="form-control" id="txtoldPassword" name="txtoldPassword" placeholder="Old Password">
					</div>
				</div>
				<div class="form-group">
					<label for="" class="col-lg-5 control-label">New Password</label>
					<div class="col-lg-7">
				...
				<div class="form-group">
					<label for="" class="col-lg-5 control-label">Confirm Password</label>
					<div class="col-lg-7">
