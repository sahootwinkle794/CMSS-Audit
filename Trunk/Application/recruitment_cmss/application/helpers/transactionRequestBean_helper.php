...
class TransactionRequestBean
{
    ...
    public function getTransactionToken()
    {
    	...
    	$file = $base_url."public/pglogs/pglog_".date('d-M-Y').".txt";
    	$log_text = "";
    	$log_text .= "MerchantCode:".$this->merchantCode."|";
    	$log_text .= "AccountNo:".$this->accountNo."|";
    	$log_text .= "ITC:".$this->ITC."|";
    	$log_text .= "MobileNumber:".$this->mobileNumber."|";
    	$log_text .= "CustomerName:".$this->customerName."|";
    	$log_text .= "RequestType:".$this->requestType."|";
    	$log_text .= "MerchantTxnRefNumber:".$this->merchantTxnRefNumber."|";
    	$log_text .= "Amount:".$this->amount."|";
    	$log_text .= "CurrencyCode:".$this->currencyCode."|";
    	$log_text .= "ReturnURL:".$this->returnURL."|";
    	$log_text .= "S2SReturnURL:".$this->s2SReturnURL."|";
    	$log_text .= "ShoppingCartDetails:".$this->shoppingCartDetails."|";
    	$log_text .= "TxnDate:".$this->txnDate."|";
    	$log_text .= "BankCode:".$this->bankCode."|";
    	$log_text .= "TPSLTxnID:".$this->TPSLTxnID."|";
    	$log_text .= "CustId:".$this->custId."|";
    	$log_text .= "CardId:".$this->cardId."|";
    	$log_text .= "WebServiceLocator:".$this->webServiceLocator."|";
    	$log_text .= "MMID:".$this->MMID."|";
    	$log_text .= "OTP:".$this->OTP."|";
    	$log_text .= "CardName:".$this->cardName."|";
    	$log_text .= "CardNo:".$this->cardNo."|";
    	$log_text .= "CardCVV:".$this->cardCVV."|";
    	$log_text .= "CardExpMM:".$this->cardExpMM."|";
    	$log_text .= "CardExpYY:".$this->cardExpYY."|";
    	$log_text .= "TimeOut:".$this->timeOut;
